    ...
    {if $products}
        <div class="ab__deal_of_the_day {if $block.properties.product_full_width === "YesNo::YES"|enum}pd-fullwidth{/if}">
            {if $settings.abt__device !== "mobile"}
                <div class="pd-block">
                    ...
                    <div class="pd-promotion__buttons">
                        <a href="{"promotions.view?promotion_id=`$promotion.promotion_id`"|fn_url}" title="{__("ab__dotd.view_promotion")}" class="ty-btn ty-btn__primary"><span>{__("ab__dotd.view_promotion")}</span><i class="ut2-icon-arrow_forward_black"></i></a>
                        <a href="{"promotions.list"|fn_url}" title="{__("ab__dotd.all_promotions_list")}" class="ty-btn ty-btn__outline"><span>{__("ab__dotd.all_promotions_list")}</span></a>
                    </div>
                </div>
            ...
            {else}
                ...
                <div class="pd-promotion__buttons">
                    <a href="{"promotions.view?promotion_id=`$promotion.promotion_id`"|fn_url}" title="{__("ab__dotd.view_promotion")}" class="ty-btn ty-btn__primary"><span>{__("ab__dotd.view_promotion")}</span><i class="ut2-icon-arrow_forward_black"></i></a>
                    <a href="{"promotions.list"|fn_url}" title="" class="ty-btn ty-btn__outline"><span>{__("ab__dotd.all_promotions_list")}</span></a>
                </div>
            {/if}
        </div>
    {/if}
