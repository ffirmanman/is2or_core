<div id="category_products_subcategories_{$block.block_id}">
{if $subcategories && $settings.abt__yt.general.view_cat_subcategories =="Y"}
...
{elseif $ab__sf_pages_as_subcategories && $settings.abt__yt.general.view_cat_subcategories == "Y"}
    <ul class="subcategories clearfix">
        {hook name="categories:view_subcategories"}{/hook}
    </ul>
{/if}
<!--category_products_subcategories_{$block.block_id}--></div>