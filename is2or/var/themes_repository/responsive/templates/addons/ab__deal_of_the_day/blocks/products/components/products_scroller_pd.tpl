...
<div id="scroll_list_{$block.block_id}"
	 class="jcarousel-skin owl-carousel ty-scroller ty-scroller-list ab-scroller-pd"
	 style="--gl-thumbs-height:{$settings.Thumbnails.product_lists_thumbnail_height};--gl-thumbs-width:{$settings.Thumbnails.product_lists_thumbnail_width};"
