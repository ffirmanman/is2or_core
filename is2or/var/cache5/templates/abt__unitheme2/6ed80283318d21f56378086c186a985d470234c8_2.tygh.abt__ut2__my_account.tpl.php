...
/* Smarty version 4.3.0, created on 2025-05-27 06:11:17
  from '/srv/projects/is2or.com/public_html/design/themes/abt__unitheme2/templates/blocks/static_templates/abt__ut2__my_account.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6835b9f522eaf7_88259892',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6ed80283318d21f56378086c186a985d470234c8' => 
    array (
      0 => '/srv/projects/is2or.com/public_html/design/themes/abt__unitheme2/templates/blocks/static_templates/abt__ut2__my_account.tpl',
      1 => 1736836654,
      2 => 'tygh',
    ),
  ),
...
function content_6835b9f522eaf7_88259892 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/srv/projects/is2or.com/public_html/app/functions/smarty_plugins/modifier.count.php','function'=>'smarty_modifier_count',),1=>array('file'=>'/srv/projects/is2or.com/public_html/app/functions/smarty_plugins/modifier.enum.php','function'=>'smarty_modifier_enum',),2=>array('file'=>'/srv/projects/is2or.com/public_html/app/functions/smarty_plugins/modifier.trim.php','function'=>'smarty_modifier_trim',),3=>array('file'=>'/srv/projects/is2or.com/public_html/app/functions/smarty_plugins/function.set_id.php','function'=>'smarty_function_set_id',),));
...
<div class="ut2-account-info">
    ...
    <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_id']) {?>
        <?php if ($_smarty_tpl->tpl_vars['user_info']->value['firstname'] || $_smarty_tpl->tpl_vars['user_info']->value['lastname']) {?>
            <div class="ut2-account-info__avatar"><?php echo htmlspecialchars((string) fn_substr($_smarty_tpl->tpl_vars['user_info']->value['firstname'],0,1), ENT_QUOTES, 'UTF-8');?>
</div>
            <p><a class="ut2-account-info__a" href="<?php echo htmlspecialchars((string) fn_url("profiles.update"), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow"><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['user_info']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['user_info']->value['lastname'], ENT_QUOTES, 'UTF-8');?>
<br/><span><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['user_info']->value['email'], ENT_QUOTES, 'UTF-8');?>
</span>
            </a></p>
        <?php }?>
...
?>
    ...
    <?php } else { ?>
        ...
        <p><a href="<?php if ($_smarty_tpl->tpl_vars['runtime']->value['controller'] == "auth" && $_smarty_tpl->tpl_vars['runtime']->value['mode'] == "login_form") {
echo htmlspecialchars((string) fn_url($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
} else {
echo htmlspecialchars((string) fn_url("auth.login_form?return_url=".((string)$_smarty_tpl->tpl_vars['return_current_url']->value)), ENT_QUOTES, 'UTF-8');
}?>" data-ca-target-id="login_block<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['block']->value['snapping_id'], ENT_QUOTES, 'UTF-8');?>
" data-ca-dialog-title="<?php echo $_smarty_tpl->__("sign_in");?>
" class="underlined cm-dialog-opener cm-dialog-auto-size" rel="nofollow"><?php echo $_smarty_tpl->__("sign_in");?>
</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="<?php echo htmlspecialchars((string) fn_url("profiles.add"), ENT_QUOTES, 'UTF-8');?>
" class="underlined" rel="nofollow"><?php echo $_smarty_tpl->__("register");?>
</a><br/><span><?php echo $_smarty_tpl->__("abt__ut2_sign_in_please");?>
</span></p>
    <?php }?>
<!--account_info_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['block']->value['snapping_id'], ENT_QUOTES, 'UTF-8');?>
--></div>

<?php if ($_smarty_tpl->tpl_vars['settings']->value['ab__device'] === "mobile" || $_smarty_tpl->tpl_vars['auth']->value['user_id']) {?>
    <?php $_smarty_tpl->_assignInScope('return_current_url', rawurlencode((string)$_smarty_tpl->tpl_vars['config']->value['current_url']));?>
    <nav class="ut2-fm ut2-account-links">
        <div class="ut2-fmw toggle-it">
        <div class="ut2-mt"><?php echo $_smarty_tpl->__("account");?>
<i></i></div>
        <div class="ut2-lfl">
            <p><a href="<?php echo htmlspecialchars((string) fn_url("orders.search"), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow"><?php echo $_smarty_tpl->__("orders");?>
</a></p>
            <p><a href="<?php echo htmlspecialchars((string) fn_url("wishlist.view"), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow"><?php echo $_smarty_tpl->__("wishlist");?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['enable_compare_products'] == 'Y') {?>
                ...
                <p><a href="<?php echo htmlspecialchars((string) fn_url("product_features.compare"), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow"><?php echo $_smarty_tpl->__("comparison_list");
if ($_smarty_tpl->tpl_vars['compared_products_ids']->value) {?> (<?php echo htmlspecialchars((string) smarty_modifier_count($_smarty_tpl->tpl_vars['compared_products_ids']->value), ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['enable_edp'] == smarty_modifier_enum("YesNo::YES")) {?>
                <p><a href="<?php echo htmlspecialchars((string) fn_url("orders.downloads"), ENT_QUOTES, 'UTF-8');?>
...
if ($_smarty_tpl->tpl_vars['auth']->value['area'] == "A") {?><span class="cm-template-box template-box" data-ca-te-template="blocks/static_templates/abt__ut2__my_account.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/static_templates/abt__ut2__my_account.tpl"),$_smarty_tpl);?>
