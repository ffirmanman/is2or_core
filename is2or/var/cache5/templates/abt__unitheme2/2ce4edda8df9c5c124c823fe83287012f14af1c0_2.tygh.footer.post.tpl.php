...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6835b9f68cc6f2_87525649',
...
function content_6835b9f68cc6f2_87525649 (Smarty_Internal_Template $_smarty_tpl) {
...
echo htmlspecialchars((string) fn_url("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->tpl_vars['products']->value)."&redirect_url=".$_prefixVariable40), ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars((string) fn_url("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->tpl_vars['products']->value)."&redirect_url=".$_prefixVariable41), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="ab-ec-comparison-modal__icon cm-confirm cm-dialog-closer ty-icon-trashcan cm-tooltip" title="<?php echo $_smarty_tpl->__("clear_list");?>
"></a></li><?php
}
...
echo htmlspecialchars((string) fn_url("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->tpl_vars['products']->value)."&redirect_url=".$_prefixVariable42), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="ab-ec-comparison-modal__icon cm-confirm cm-dialog-closer ty-icon-trashcan cm-tooltip" title="<?php echo $_smarty_tpl->__("clear_list");?>
"></a><?php }?></li><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['comparison_lists']->value, 'comparison_list');
$_smarty_tpl->tpl_vars['comparison_list']->do_else = true;
...
echo htmlspecialchars((string) fn_url("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->tpl_vars['products']->value)."&redirect_url=".$_prefixVariable43), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="ab-ec-comparison-modal__icon cm-confirm cm-dialog-closer ty-icon-trashcan cm-tooltip" title="<?php echo $_smarty_tpl->__("clear_list");?>
"></a></li><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul><!--account_info_ab__extended_comparison_wishlist_groups--></div><?php }
