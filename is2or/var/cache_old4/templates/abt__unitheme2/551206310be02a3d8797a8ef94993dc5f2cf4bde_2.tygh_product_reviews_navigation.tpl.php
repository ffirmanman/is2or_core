...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb4a00e00467_73118187',
...
function content_69fb4a00e00467_73118187 (\Smarty\Template $_smarty_tpl) {
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')($_smarty_tpl->getSmarty()->getModifierCallback('fn_link_attach')($_smarty_tpl->getValue('curl'),"only_buyers=".$_prefixVariable44."&selected_section=product_reviews"))), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')($_smarty_tpl->getSmarty()->getModifierCallback('fn_link_attach')($_smarty_tpl->getValue('curl'),"with_images=".$_prefixVariable45."&selected_section=product_reviews"))), ENT_QUOTES, 'UTF-8');?>
"
                   class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                   data-ca-target-id="product_reviews_list_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('product_id')), ENT_QUOTES, 'UTF-8');?>
"
...
"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")('abt__ut2.product_reviews.filter.rating.all_ratings', [], $_smarty_tpl->getSmarty()->getLanguage());?>
                        ...
                        <?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, array(1,2,3,4,5), 'stars');
$foreach161DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('stars')->value) {
$foreach161DoElse = false;
?>
                            <li class="ty-sort-dropdown__content-item">
                                <a class="ty-sort-dropdown__content-item-a  cm-ajax"
                                   href="<?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')($_smarty_tpl->getSmarty()->getModifierCallback('fn_link_attach')($_smarty_tpl->getValue('curl'),"&abt__ut2_reviews_rating=".((string)$_smarty_tpl->getValue('stars'))."&selected_section=product_reviews"))), ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')($_smarty_tpl->getSmarty()->getModifierCallback('fn_link_attach')($_smarty_tpl->getValue('curl'),"only_buyers=".$_prefixVariable46."&selected_section=product_reviews"))), ENT_QUOTES, 'UTF-8');?>
"
                   class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                   data-ca-target-id="product_reviews_list_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('product_id')), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')($_smarty_tpl->getSmarty()->getModifierCallback('fn_link_attach')($_smarty_tpl->getValue('curl'),"with_images=".$_prefixVariable47."&selected_section=product_reviews"))), ENT_QUOTES, 'UTF-8');?>
"
                   class="ty-product-review-reviews-navigation__filter-link cm-ajax"
                   data-ca-target-id="product_reviews_list_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('product_id')), ENT_QUOTES, 'UTF-8');?>
"
