...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb4a0751bfe2_97170301',
...
function content_69fb4a0751bfe2_97170301 (\Smarty\Template $_smarty_tpl) {
...
} elseif ($_smarty_tpl->getValue('addons')['discussion']['status'] == $_smarty_tpl->getSmarty()->getModifierCallback('enum')("ObjectStatuses::ACTIVE")) {?><div class="ty-nowrap ty-stars"><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i><i class="ty-icon-star-empty"></i></div><?php }
}?></div><?php }
$_block_repeat=false;
