...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb49ff7f1aa1_43412637',
...
function content_69fb49ff7f1aa1_43412637 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('label_text', $_prefixVariable24." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
    <?php } else { ?>
        <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("master_products.save_up_to", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable25=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable25." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
    <?php }?>
...
$_smarty_tpl->assign('label_text', $_prefixVariable26." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
    <?php } else { ?>
        <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("master_products.save_up_to", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable27=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable27." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
    <?php }?>
