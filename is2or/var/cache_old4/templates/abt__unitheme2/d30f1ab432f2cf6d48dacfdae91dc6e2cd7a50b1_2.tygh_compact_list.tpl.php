...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb5578198347_42760371',
...
function content_69fb5578198347_42760371 (\Smarty\Template $_smarty_tpl) {
...
?>
    ...
    <div class="ty-compact-list <?php if ($_smarty_tpl->getValue('settings')['abt__ut2']['product_list']['short_list']['show_two_columns'][$_smarty_tpl->getValue('settings')['ab__device']] === $_smarty_tpl->getSmarty()->getModifierCallback('enum')("YesNo::YES")) {?> show-two-columns<?php }?>" style="--compact-list-image-width: <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('tbw')), ENT_QUOTES, 'UTF-8');?>
;--compact-list-image-height: <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('tbh')), ENT_QUOTES, 'UTF-8');?>
;">
