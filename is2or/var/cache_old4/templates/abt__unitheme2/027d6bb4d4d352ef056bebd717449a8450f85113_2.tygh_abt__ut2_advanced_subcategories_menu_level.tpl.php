...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb4a06585e57_95104652',
...
function content_69fb4a06585e57_95104652 (\Smarty\Template $_smarty_tpl) {
...
echo htmlspecialchars((string) ($_prefixVariable15), ENT_QUOTES, 'UTF-8');?>
</em>
                <?php }?>
            </span>
        <?php } else { ?>
...
echo htmlspecialchars((string) ($_prefixVariable16), ENT_QUOTES, 'UTF-8');?>
</em>
                <?php }?>
            </a>
...
echo htmlspecialchars((string) ($_prefixVariable17), ENT_QUOTES, 'UTF-8');?>
</em>
                <?php }?>
            </span>
        <?php } else { ?>
...
echo htmlspecialchars((string) ($_prefixVariable18), ENT_QUOTES, 'UTF-8');?>
</em>
                <?php }?>
            </a>
            <?php if ($_smarty_tpl->getValue('parent')) {?></div><?php }?>
