...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb4a018d3601_29054837',
...
function content_69fb4a018d3601_29054837 (\Smarty\Template $_smarty_tpl) {
...
_search" href="javascript:void(0);" rel="nofollow" class="ut2-btn-search ut2-sticky-panel__link cm-combination"><i class="ut2-icon-search"></i><?php if ($_smarty_tpl->getValue('settings')['abt__ut2']['general']['sticky_panel']['enable_sticky_panel_labels'][$_smarty_tpl->getValue('settings')['ab__device']] === $_smarty_tpl->getSmarty()->getModifierCallback('enum')("YesNo::YES")) {?><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("search", [], $_smarty_tpl->getSmarty()->getLanguage());?>
</span><?php }?></a>
            <a id="off_dropdown_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('block_snapping_id_replacement')), ENT_QUOTES, 'UTF-8');?>
_search" href="javascript:void(0);" rel="nofollow" class="ut2-btn-search ut2-sticky-panel__link cm-combination" style="display:none;"><i class="ut2-icon-baseline-close"></i></a>
...
"<?php }?>>
                <div class="ty-dropdown-box" id="sticky_cart_status_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('dropdown_id')), ENT_QUOTES, 'UTF-8');?>
">
...
" class="ut2-sticky-panel__link" id="cart_status_icon_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('dropdown_id')), ENT_QUOTES, 'UTF-8');?>
">
                        ...
                        <!--cart_status_icon_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('dropdown_id')), ENT_QUOTES, 'UTF-8');?>
--></a>
                    </div>
...
" class="ty-dropdown-box__content ty-dropdown-box__content--cart hidden">
                        ...
                        <a href="javascript:void(0);" rel="nofollow" class="ut2-btn-close cm-combination" id="off_dropdown_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('dropdown_id')), ENT_QUOTES, 'UTF-8');?>
...
while ($_block_repeat) {
  ob_start();
?>
                            <div class="cm-cart-content cm-cart-content-thumb" id="cart_status_content_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('dropdown_id')), ENT_QUOTES, 'UTF-8');?>
">

                                    <div class="ut2-minicart<?php if ((!$_smarty_tpl->getValue('runtime')['checkout'] || $_smarty_tpl->getValue('force_items_deletion')) && !$_smarty_tpl->getValue('product')['extra']['exclude_from_calculate']) {?> has-rm-btn<?php }?>">
...
?>
                            ...
                            <!--cart_status_content_<?php echo $_smarty_tpl->getValue('dropdown_id');?>
--></div>
                        <?php $_block_repeat=false;
...
?>
                    ...
                    <div class="ut2-sticky-panel__item__overlay"></div>
            <!--sticky_cart_status_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('dropdown_id')), ENT_QUOTES, 'UTF-8');?>
--></div>
        </div>
        <?php }?>
...
_acc" class="ty-dropdown-box__title cm-combination">
...
_acc" class="ty-dropdown-box__content hidden">
                        ...
                        <a href="javascript:void(0);" rel="nofollow" class="ut2-btn-close cm-combination" id="off_dropdown_<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('block_snapping_id_replacement')), ENT_QUOTES, 'UTF-8');?>
...
"<?php }?>>
                <div class="ty-dropdown-box" id="phones_info_acc">
                    <div id="sw_dropdown_phones_info_acc" class="ty-dropdown-box__title cm-combination">
                        <a class="ut2-sticky-panel__link" href="javascript:void(0);" rel="nofollow"><i class="ut2-icon-local_phone"></i><?php if ($_smarty_tpl->getValue('settings')['abt__ut2']['general']['sticky_panel']['enable_sticky_panel_labels'][$_smarty_tpl->getValue('settings')['ab__device']] === $_smarty_tpl->getSmarty()->getModifierCallback('enum')("YesNo::YES")) {?><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("abt__ut2.settings.general.sticky_panel.phones", [], $_smarty_tpl->getSmarty()->getLanguage());?>
</span><?php }?></a>
                    </div>
                    <div id="dropdown_phones_info_acc" class="ty-dropdown-box__content hidden">
                        <a href="javascript:void(0);" rel="nofollow" class="ut2-btn-close cm-combination" id="off_dropdown_phones_info_acc"><i class="ut2-icon-baseline-close"></i></a>
...
?>
                                ...
                                <div class="ut2-social-links">
                                    <?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")('abt__ut2__block_contacts.social_links', [], $_smarty_tpl->getSmarty()->getLanguage());?>
...
$foreach185DoElse = true;
foreach ($_from ?? [] as $_smarty_tpl->getVariable('key')->value => $_smarty_tpl->getVariable('product')->value) {
$foreach185DoElse = false;
?>
                                                        <?php $_block_repeat=true;
if (!$_smarty_tpl->getSmarty()->getBlockHandler('hook')) {
throw new \Smarty\Exception('block tag \'hook\' not callable or registered');
