...
/* Smarty version 5.4.3, created on 2026-05-06 17:02:49
  from 'tygh:blocks/wrappers/abt__ut2__mainbox_general.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69fb4a094d5980_93458727',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3a7e61a15cd6c8820cf2365a76fbf810bf1509e5' => 
    array (
      0 => 'blocks/wrappers/abt__ut2__mainbox_general.tpl',
      1 => 1767831046,
      2 => 'tygh',
    ),
  ),
...
function content_69fb4a094d5980_93458727 (\Smarty\Template $_smarty_tpl) {
...
while ($_block_repeat) {
  ob_start();
?>
                <div class="ty-mainbox-title <?php if ($_smarty_tpl->getValue('block')['properties']['outside_navigation'] == "Y") {?>outside-controls<?php }?>">
                    <?php $_block_repeat=true;
if (!$_smarty_tpl->getSmarty()->getBlockHandler('hook')) {
throw new \Smarty\Exception('block tag \'hook\' not callable or registered');
}
...
if ($_smarty_tpl->getValue('auth')['area'] == "A") {?><span class="cm-template-box template-box" data-ca-te-template="blocks/wrappers/abt__ut2__mainbox_general.tpl" id="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('set_id')->handle(array('name'=>"blocks/wrappers/abt__ut2__mainbox_general.tpl"), $_smarty_tpl);?>
