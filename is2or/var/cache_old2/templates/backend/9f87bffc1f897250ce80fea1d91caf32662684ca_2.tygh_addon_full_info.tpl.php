...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb1ae934428_53335664',
...
function content_69afb1ae934428_53335664 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('verified_developer', ($_smarty_tpl->getValue('a')['identified'] || $_smarty_tpl->getValue('a')['is_core_addon']) ? " (".$_prefixVariable22.")" : '', false, NULL);?>
...
$_smarty_tpl->assign('addon_full_version_info', $_prefixVariable23.":
...
$_smarty_tpl->assign('addon_full_version_info', $_prefixVariable24.":
...
$_smarty_tpl->assign('addon_full_version_info', $_prefixVariable26.":
".((string)$_smarty_tpl->getValue('actual_version'))."
...
".$_prefixVariable29.": ".((string)$_smarty_tpl->getValue('a')['supplier']).((string)$_smarty_tpl->getValue('verified_developer'))."
".$_prefixVariable30.": ".((string)$_smarty_tpl->getValue('addon')['addon']), false, 2);
} else { ?>  
<?php ob_start();
...
".$_prefixVariable31.": ".((string)((($tmp = $_smarty_tpl->getValue('addon')['version'] ?? null)===null||$tmp==='' ? 0.1 ?? null : $tmp)))."
".$_prefixVariable32.": ".((string)$_smarty_tpl->getValue('install_datetime_format'))."
".$_prefixVariable33.": ".((string)$_smarty_tpl->getValue('a')['supplier']).((string)$_smarty_tpl->getValue('verified_developer'))."
".$_prefixVariable34.": ".((string)$_smarty_tpl->getValue('addon')['addon'])."
".$_prefixVariable35.": ".((string)$_smarty_tpl->getValue('status_description')), false, 2);
}?>

<?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("installed_date", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable36=ob_get_clean();
$_smarty_tpl->assign('install_datetime_full_info', $_prefixVariable36.":
