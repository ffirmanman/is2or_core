...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb1afa38078_09854219',
...
function content_69afb1afa38078_09854219 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('popup_title', $_prefixVariable55.": ".((string)$_smarty_tpl->getValue('menu_name')), false, NULL);
} else {
...
$_smarty_tpl->renderSubTemplate("tygh:common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('act'=>"edit",'text'=>$_smarty_tpl->getValue('popup_title'),'link_text'=>$_prefixVariable56."...",'href'=>"block_manager.update_custom_block?object_type=menu_item&block_id=0&return_url=".((string)$_smarty_tpl->getValue('current_dispatch')).((string)$_smarty_tpl->getValue('extra_params_query')),'content'=>'','id'=>((string)$_smarty_tpl->getValue('id'))."_second_level_add",'link_class'=>"main-menu-".((string)$_smarty_tpl->getValue('level'))."__link",'icon'=>"icon-plus",'no_icon_link'=>true), (int) 0, $_smarty_current_dir);
?></div></div><?php }
}
}
