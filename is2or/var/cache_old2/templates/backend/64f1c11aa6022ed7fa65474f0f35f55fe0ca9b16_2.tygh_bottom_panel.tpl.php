...
/* Smarty version 5.4.3, created on 2026-03-10 08:52:46
  from 'tygh:components/bottom_panel/bottom_panel.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb1ae7a9762_52056714',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '64f1c11aa6022ed7fa65474f0f35f55fe0ca9b16' => 
    array (
...
function content_69afb1ae7a9762_52056714 (\Smarty\Template $_smarty_tpl) {
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("bottom_panel.redirect?url=".((string)($_smarty_tpl->getSmarty()->getModifierCallback('urlencode')($_smarty_tpl->getValue('config')['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable12,$_smarty_tpl->getValue('redirect_area'))), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable13)), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->getValue('active_mode') === "theme") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('urlencode')($_smarty_tpl->getValue('config')['current_url'])), ENT_QUOTES, 'UTF-8');
$_prefixVariable14=ob_get_clean();
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable14)), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->getValue('active_mode') === "build") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('urlencode')($_smarty_tpl->getValue('config')['current_url'])), ENT_QUOTES, 'UTF-8');
$_prefixVariable15=ob_get_clean();
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable15)), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } else { ?>
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable16)), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable17)), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable18)), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                            id="settings_block_manager"
