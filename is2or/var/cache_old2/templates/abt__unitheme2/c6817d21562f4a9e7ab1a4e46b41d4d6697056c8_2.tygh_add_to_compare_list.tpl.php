...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afafa96cf971_96855604',
...
function content_69afafa96cf971_96855604 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('but_href', (($tmp = $_smarty_tpl->getValue('compare_but_href') ?? null)===null||$tmp==='' ? "product_features.add_product?product_id=".((string)$_smarty_tpl->getValue('product_id'))."&redirect_url=".$_prefixVariable9 ?? null : $tmp), false, NULL);?>
...
$_smarty_tpl->assign('but_href', (($tmp = $_smarty_tpl->getValue('compare_but_href') ?? null)===null||$tmp==='' ? "product_features.add_product?product_id=".((string)$_smarty_tpl->getValue('product_id'))."&redirect_url=".$_prefixVariable10 ?? null : $tmp), false, NULL);?>
