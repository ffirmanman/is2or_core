...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afafa94a51b9_13131175',
...
function content_69afafa94a51b9_13131175 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable11.".", false, NULL);
...
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable12.".", false, NULL);
}
...
<?php } elseif ($_smarty_tpl->getValue('button')) {?>
    <button type="button"
    class="ty-product-review-reviews-stars__button ty-btn-reset cm-external-click <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('meta')), ENT_QUOTES, 'UTF-8');?>
"
...
"
    >
<?php }?>
<div class="ty-product-review-reviews-stars <?php if ($_smarty_tpl->getValue('settings')['abt__ut2']['product_list']['show_rating_num'] == $_smarty_tpl->getSmarty()->getModifierCallback('enum')("YesNo::YES") && $_smarty_tpl->getValue('integer_rating_math') < 4.25) {?>is-half <?php }
...
if ($_smarty_tpl->getValue('settings')['abt__ut2']['product_list']['show_rating_num'] == $_smarty_tpl->getSmarty()->getModifierCallback('enum')("YesNo::YES")) {?> ut2-show-rating-num<?php }?>"
     data-ca-product-review-reviews-stars-rating="<?php echo htmlspecialchars((string) (round((float) $_smarty_tpl->getValue('rating'), (int) 0, (int) 1)), ENT_QUOTES, 'UTF-8');?>
"
...
"
        <?php if (!$_smarty_tpl->getValue('link') && !$_smarty_tpl->getValue('button')) {?>
            title="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('title')), ENT_QUOTES, 'UTF-8');?>
"
        <?php }?>
></div>
...
<?php }
if ($_smarty_tpl->getValue('product')['reviews_count']) {?><div class="cn-reviews">(<?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("product_reviews.reviews", array($_smarty_tpl->getValue('product')['reviews_count']), $_smarty_tpl->getSmarty()->getLanguage());?>
)</div><?php }
...
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable13.".", false, NULL);
} elseif ($_smarty_tpl->getValue('button')) {?>
    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("product_reviews.click_to_see_reviews", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable14=ob_get_clean();
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable14.".", false, NULL);
}
if ($_smarty_tpl->getValue('link') === true) {?>
    <?php $_smarty_tpl->assign('link', "products.view?product_id=".((string)$_smarty_tpl->getValue('product')['product_id'])."&selected_section=product_reviews#product_reviews", false, NULL);
}?>
