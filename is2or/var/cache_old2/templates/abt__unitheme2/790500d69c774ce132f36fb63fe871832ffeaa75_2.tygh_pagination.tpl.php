...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afafa954b825_00098157',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '790500d69c774ce132f36fb63fe871832ffeaa75' => 
    array (
...
function content_69afafa954b825_00098157 (\Smarty\Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->getValue('pagination')['total_pages'] > 1) {?>
    ...
    <?php $_smarty_tpl->assign('ajax_class', (!$_smarty_tpl->getValue('config')['tweaks']['disable_dhtml'] || $_smarty_tpl->getValue('force_ajax')) ? "cm-ajax" : '', false, NULL);?>
    <?php $_smarty_tpl->assign('ajax_full_render_class', ($_smarty_tpl->getValue('full_render')) ? "cm-ajax-full-render" : '', false, NULL);?>
    <?php $_smarty_tpl->assign('extra_id', (($tmp = $_smarty_tpl->getValue('extra_id') ?? null)===null||$tmp==='' ? '' ?? null : $tmp), false, NULL);?>

    <?php if ($_smarty_tpl->getSmarty()->getRuntime('Capture')->getBuffer($_smarty_tpl, 'pagination_open') == "Y") {?>
    <div class="ty-pagination__bottom">
    <?php }?>
    <div class="ty-pagination" id="ut2_pagination_block<?php if ($_smarty_tpl->getSmarty()->getRuntime('Capture')->getBuffer($_smarty_tpl, 'pagination_open') == "Y") {?>_bottom<?php }?>">
        <?php if ($_smarty_tpl->getValue('settings')['ab__device'] !== "desktop") {?>
        <a data-ca-scroll=".cm-pagination-container" href="<?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')(((string)$_smarty_tpl->getValue('c_url'))."&page=1".((string)$_smarty_tpl->getValue('extra_url')))), ENT_QUOTES, 'UTF-8');?>
" data-ca-page="1" class="cm-history ty-pagination__item ty-pagination__range <?php if ($_smarty_tpl->getValue('pagination')['current_page'] == 1) {?>mute<?php }?> <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('ajax_class')), ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('ajax_full_render_class')), ENT_QUOTES, 'UTF-8');?>
" data-ca-target-id="<?php echo htmlspecialchars((string) (($_smarty_tpl->getValue('id')).($_smarty_tpl->getValue('extra_id'))), ENT_QUOTES, 'UTF-8');?>
">1</a>
        <?php }?>
...
" data-ca-target-id="<?php echo htmlspecialchars((string) (($_smarty_tpl->getValue('id')).($_smarty_tpl->getValue('extra_id'))), ENT_QUOTES, 'UTF-8');?>
"<?php }?>><?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('include_ext')->handle(array('file'=>"common/icon.tpl",'class'=>"ty-pagination__text-arrow"), $_smarty_tpl);?>
&nbsp;<span class="ty-pagination__text"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("prev_page", [], $_smarty_tpl->getSmarty()->getLanguage());?>
</span></a>
...
}?> ty-pagination__right-arrow" <?php if ($_smarty_tpl->getValue('pagination')['next_page']) {?>href="<?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')(((string)$_smarty_tpl->getValue('c_url'))."&page=".((string)$_smarty_tpl->getValue('pagination')['next_page']).((string)$_smarty_tpl->getValue('extra_url')))), ENT_QUOTES, 'UTF-8');?>
...
</span>&nbsp;<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('include_ext')->handle(array('file'=>"common/icon.tpl",'class'=>"ty-pagination__text-arrow"), $_smarty_tpl);?>
</a>
...
"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pagination')['next_range_from']), ENT_QUOTES, 'UTF-8');?>
 - <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pagination')['next_range_to']), ENT_QUOTES, 'UTF-8');?>
        ...
        <?php }?>
        <?php if ($_smarty_tpl->getValue('settings')['ab__device'] !== "desktop") {?>
        <a data-ca-scroll=".cm-pagination-container" href="<?php echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')(((string)$_smarty_tpl->getValue('c_url'))."&page=".((string)$_smarty_tpl->getValue('pagination')['total_pages']).((string)$_smarty_tpl->getValue('extra_url')))), ENT_QUOTES, 'UTF-8');?>
" data-ca-page="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pagination')['total_pages']), ENT_QUOTES, 'UTF-8');?>
" class="cm-history ty-pagination__item ty-pagination__range <?php if ($_smarty_tpl->getValue('pagination')['current_page'] == $_smarty_tpl->getValue('pagination')['total_pages']) {?>mute<?php }?> <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('ajax_class')), ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('ajax_full_render_class')), ENT_QUOTES, 'UTF-8');?>
" data-ca-target-id="<?php echo htmlspecialchars((string) (($_smarty_tpl->getValue('id')).($_smarty_tpl->getValue('extra_id'))), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pagination')['total_pages']), ENT_QUOTES, 'UTF-8');?>
</a>
        <?php }?>
    <!--ut2_pagination_block<?php if ($_smarty_tpl->getSmarty()->getRuntime('Capture')->getBuffer($_smarty_tpl, 'pagination_open') == "Y") {?>_bottom<?php }?>--></div>
    <?php if ($_smarty_tpl->getSmarty()->getRuntime('Capture')->getBuffer($_smarty_tpl, 'pagination_open') == "Y") {?>
        </div>
    <?php }?>
    <?php } else { ?>
        <div class="hidden"><a data-ca-scroll=".cm-pagination-container" href="" data-ca-page="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pg')), ENT_QUOTES, 'UTF-8');?>
" data-ca-target-id="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('id')), ENT_QUOTES, 'UTF-8');?>
" class="hidden"></a></div>
    <?php }
}?>
