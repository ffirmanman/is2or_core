...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afafa95f1b66_12569218',
...
function content_69afafa95f1b66_12569218 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('label_text', $_prefixVariable3." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable4=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable4." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable5 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
...
$foreach2Backup = clone $_smarty_tpl->getVariable('var');
?>
...
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach2Backup);
}
...
$_smarty_tpl->assign('label_text', $_prefixVariable6." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable7=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable7." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable8 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['price'], false, NULL);?>
                <?php } else { ?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['clean_price'], false, NULL);?>
                <?php }?>
...
$_smarty_tpl->getVariable('var')->iteration++;
$_smarty_tpl->getVariable('var')->last = $_smarty_tpl->getVariable('var')->iteration === $_smarty_tpl->getVariable('var')->total;
$foreach4Backup = clone $_smarty_tpl->getVariable('var');
?>
                        <option value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->getValue('product')['selected_amount'] && ($_smarty_tpl->getValue('product')['selected_amount'] == $_smarty_tpl->getValue('var') || ($_smarty_tpl->getVariable('var')->last && !$_smarty_tpl->getValue('selected_amount')))) {
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach4Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                </select>
                <?php } else { ?>
