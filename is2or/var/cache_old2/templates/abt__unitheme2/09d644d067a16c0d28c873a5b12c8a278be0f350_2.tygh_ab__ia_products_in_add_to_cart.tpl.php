...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afafa5da8533_32853462',
...
function content_69afafa5da8533_32853462 (\Smarty\Template $_smarty_tpl) {
...
$foreach8Backup = clone $_smarty_tpl->getVariable('j');
?>
...
" class="abt__ut2_grid_tabs ty-tabs__item cm-js <?php if ($_smarty_tpl->getVariable('j')->first) {?>active<?php }?>">
                ...
                <?php
$_smarty_tpl->setVariable('j', $foreach8Backup);
}
...
$_smarty_tpl->getVariable('j')->index++;
$_smarty_tpl->getVariable('j')->first = !$_smarty_tpl->getVariable('j')->index;
$foreach9Backup = clone $_smarty_tpl->getVariable('j');
?>
...
?>
                ...
                <?php
$_smarty_tpl->setVariable('j', $foreach9Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
            </div>
        </div>
