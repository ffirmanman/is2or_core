...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afafaa025341_92607957',
...
function content_69afafaa025341_92607957 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->renderSubTemplate("tygh:common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('obj_id'=>((string)$_smarty_tpl->getValue('preview_id'))."_".((string)$_smarty_tpl->getValue('image_id')),'images'=>$_smarty_tpl->getValue('image_pair_var'),'link_class'=>"cm-image-previewer".$_prefixVariable15.$_prefixVariable16,'image_width'=>$_smarty_tpl->getValue('image_width'),'image_height'=>$_smarty_tpl->getValue('image_height'),'image_id'=>"preview[product_images_".((string)$_smarty_tpl->getValue('preview_id'))."]"), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate("tygh:common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('images'=>$_smarty_tpl->getValue('image_pair'),'link_class'=>$_prefixVariable17."cm-image-previewer hidden",'obj_id'=>((string)$_smarty_tpl->getValue('preview_id'))."_".((string)$_smarty_tpl->getValue('img_id')),'image_width'=>$_smarty_tpl->getValue('image_width'),'image_height'=>$_smarty_tpl->getValue('image_height'),'image_id'=>"preview[product_images_".((string)$_smarty_tpl->getValue('preview_id'))."]",'image_link_additional_attrs'=>array("data-ca-image-order"=>$_smarty_tpl->getValue('image_iterator')-1)), (int) 0, $_smarty_current_dir);
?>
...
$_smarty_tpl->renderSubTemplate("tygh:common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('obj_id'=>((string)$_smarty_tpl->getValue('preview_id'))."_".((string)$_smarty_tpl->getValue('image_id')),'images'=>$_smarty_tpl->getValue('image_pair_var'),'link_class'=>"cm-image-previewer".$_prefixVariable18.$_prefixVariable19,'image_width'=>$_smarty_tpl->getValue('image_width'),'image_height'=>$_smarty_tpl->getValue('image_height'),'image_id'=>"preview[product_images_".((string)$_smarty_tpl->getValue('preview_id'))."]"), (int) 0, $_smarty_current_dir);
?>
