...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb1fd441bc2_74028166',
...
function content_69afb1fd441bc2_74028166 (\Smarty\Template $_smarty_tpl) {
...
?>
                                            ...
                                            <?php if ($_smarty_tpl->getSmarty()->getModifierCallback('count')($_smarty_tpl->getValue('item2')[$_smarty_tpl->getValue('childs')]) > $_smarty_tpl->getValue('Viewlimit')) {?>
                                                <a <?php if ((($tmp = $_smarty_tpl->getValue('block')['properties']['abt__ut2_view_more_btn_behavior'] ?? null)===null||$tmp==='' ? "view_items" ?? null : $tmp) === "view_items") {?>href="#" onclick="$(this).prev().addClass('view');$(this).addClass('hidden');" <?php } else { ?>href="<?php echo htmlspecialchars((string) ((($tmp = $_smarty_tpl->getValue('item2_url') ?? null)===null||$tmp==='' ? "javascript:void(0)" ?? null : $tmp)), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow"<?php }?> class="ut2-more-btn" title=""><span><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("more", [], $_smarty_tpl->getSmarty()->getLanguage());?>
</span></a>
                                            <?php }?>
                                        <?php }?>
