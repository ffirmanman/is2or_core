...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_6a133f6e5c62d5_34076577',
...
function content_6a133f6e5c62d5_34076577 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('label_text', $_prefixVariable28." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
    <?php } else { ?>
        <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("master_products.save_up_to", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable29=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable29." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
    <?php }?>
...
$_smarty_tpl->assign('label_text', $_prefixVariable30." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
    <?php } else { ?>
        <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("master_products.save_up_to", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable31=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable31." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
    <?php }?>
