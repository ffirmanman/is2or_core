...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_6a133f6990d5d7_78833752',
...
function content_6a133f6990d5d7_78833752 (\Smarty\Template $_smarty_tpl) {
...
if (( !$_smarty_tpl->hasVariable('meta_description') || empty($_smarty_tpl->getValue('meta_description')))) {?>
    <?php $_smarty_tpl->assign('meta_description', (($tmp = $_smarty_tpl->getValue('location_data')['meta_description'] ?? null)===null||$tmp==='' ? '' ?? null : $tmp), false, NULL);
} else { ?>
    <?php $_smarty_tpl->assign('meta_description', $_smarty_tpl->getSmarty()->getModifierCallback('html_entity_decode')($_smarty_tpl->getValue('meta_description'),(defined('ENT_COMPAT') ? constant('ENT_COMPAT') : null),"UTF-8"), false, NULL);
}?>
...
" />
<meta property="og:description" content="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('meta_description')), ENT_QUOTES, 'UTF-8');?>
" />
