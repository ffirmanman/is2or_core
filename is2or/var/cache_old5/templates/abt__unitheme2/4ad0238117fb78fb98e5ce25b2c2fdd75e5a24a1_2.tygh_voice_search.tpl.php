...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_6a133f6ba4e3f9_32831722',
...
function content_6a133f6ba4e3f9_32831722 (\Smarty\Template $_smarty_tpl) {
...
.voice-search {
    position: absolute;
    top: 50%;
    <?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null) == 'ar') {?>
        left: 40px;
    <?php } else { ?>
        right: 40px;
    <?php }?>
