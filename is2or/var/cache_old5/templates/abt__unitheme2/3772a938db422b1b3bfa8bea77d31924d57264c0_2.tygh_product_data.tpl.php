...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_6a133f6e022b78_87212423',
...
function content_6a133f6e022b78_87212423 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('label_text', $_prefixVariable14." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable15=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable15." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable16 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
...
$foreach84Backup = clone $_smarty_tpl->getVariable('var');
?>
...
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach84Backup);
}
...
$_smarty_tpl->assign('label_text', $_prefixVariable17." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable18=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable18." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable19 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['price'], false, NULL);?>
                <?php } else { ?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['clean_price'], false, NULL);?>
                <?php }?>
...
$_smarty_tpl->getVariable('var')->iteration++;
$_smarty_tpl->getVariable('var')->last = $_smarty_tpl->getVariable('var')->iteration === $_smarty_tpl->getVariable('var')->total;
$foreach86Backup = clone $_smarty_tpl->getVariable('var');
?>
                        <option value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->getValue('product')['selected_amount'] && ($_smarty_tpl->getValue('product')['selected_amount'] == $_smarty_tpl->getValue('var') || ($_smarty_tpl->getVariable('var')->last && !$_smarty_tpl->getValue('selected_amount')))) {
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach86Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                </select>
                <?php } else { ?>
