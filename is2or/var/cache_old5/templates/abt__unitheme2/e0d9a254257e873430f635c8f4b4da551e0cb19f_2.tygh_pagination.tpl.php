...
/* Smarty version 5.4.3, created on 2026-05-24 21:11:57
  from 'tygh:/var/www/is2or/design/themes/abt__unitheme2/templates/addons/is2or_design_template/overrides/common/pagination.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_6a133f6db66f66_54388298',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e0d9a254257e873430f635c8f4b4da551e0cb19f' => 
    array (
      0 => '/var/www/is2or/design/themes/abt__unitheme2/templates/addons/is2or_design_template/overrides/common/pagination.tpl',
      1 => 1778514042,
      2 => 'tygh',
    ),
  ),
...
function content_6a133f6db66f66_54388298 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/var/www/is2or/design/themes/abt__unitheme2/templates/addons/is2or_design_template/overrides/common';
...
"><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pagination')['prev_range_from']), ENT_QUOTES, 'UTF-8');?>
 - <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('pagination')['prev_range_to']), ENT_QUOTES, 'UTF-8');?>
        ...
        <?php }?>
        <a data-ca-scroll=".cm-pagination-container" class="<?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null) == 'ar') {?>ty-pagination__right-arrow <?php }?> ty-pagination__item ty-pagination__btn <?php if ($_smarty_tpl->getValue('pagination')['prev_page']) {?>ty-pagination__prev cm-history <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('ajax_class')), ENT_QUOTES, 'UTF-8');
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
        ...
        <a data-ca-scroll=".cm-pagination-container" class="<?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null) != 'ar') {?>ty-pagination__right-arrow <?php }?> ty-pagination__item ty-pagination__btn <?php if ($_smarty_tpl->getValue('pagination')['next_page']) {?>ty-pagination__next cm-history <?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('ajax_class')), ENT_QUOTES, 'UTF-8');
...
if ($_smarty_tpl->getValue('auth')['area'] == "A") {?><span class="cm-template-box template-box" data-ca-te-template="/var/www/is2or/design/themes/abt__unitheme2/templates/addons/is2or_design_template/overrides/common/pagination.tpl" id="<?php echo $_smarty_tpl->getSmarty()->getFunctionHandler('set_id')->handle(array('name'=>"/var/www/is2or/design/themes/abt__unitheme2/templates/addons/is2or_design_template/overrides/common/pagination.tpl"), $_smarty_tpl);?>
