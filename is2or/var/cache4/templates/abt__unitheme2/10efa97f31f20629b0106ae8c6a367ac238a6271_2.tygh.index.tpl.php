...
/* Smarty version 4.3.0, created on 2025-05-26 04:37:35
  from '/srv/projects/is2or.com/public_html/design/themes/abt__unitheme2/templates/index.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6834527fb256c8_69392882',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '10efa97f31f20629b0106ae8c6a367ac238a6271' => 
    array (
      0 => '/srv/projects/is2or.com/public_html/design/themes/abt__unitheme2/templates/index.tpl',
      1 => 1747370623,
      2 => 'tygh',
    ),
  ),
...
function content_6834527fb256c8_69392882 (Smarty_Internal_Template $_smarty_tpl) {
...
"
    class="<?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"index:abt_ut2_html_class"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"index:abt_ut2_html_class"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();
$_block_repeat=false;
echo smarty_block_hook(array('name'=>"index:abt_ut2_html_class"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?> <?php if ($_smarty_tpl->tpl_vars['pb_is_bottom_panel_open']->value) {?>bp-panel-active<?php }?> <?php if ($_smarty_tpl->tpl_vars['is_theme_editor_open']->value) {?>te-theme-editor-active<?php }?>"
>
<head>
...
<body class="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['location_data']->value['user_class'], ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['settings']->value['ab__device'] === "mobile") {?>mobile-screen <?php }
if ($_smarty_tpl->tpl_vars['settings']->value['ab__device'] === "tablet") {?>tablet-screen <?php }
if ($_smarty_tpl->tpl_vars['settings']->value['ab__device'] === "desktop") {?>desktop-screen <?php }?>">
