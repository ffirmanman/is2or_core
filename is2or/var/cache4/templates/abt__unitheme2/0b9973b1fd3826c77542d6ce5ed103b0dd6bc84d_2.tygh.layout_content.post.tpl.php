...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.0',
  'unifunc' => 'content_6834571d6b6644_74463265',
...
function content_6834571d6b6644_74463265 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('tpl_search_similar_button', $_prefixVariable19);?>
    <?php echo '<script'; ?>
...
$_smarty_tpl->_assignInScope('tpl_search_similar_button', $_prefixVariable20);?>
    <?php echo '<script'; ?>
>(function(_, $) {$.extend(_.abt__ut2.templates, {search_similar_button: `<?php echo strtr((string)smarty_modifier_trim($_smarty_tpl->tpl_vars['tpl_search_similar_button']->value), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", "\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S" ));?>
`});}(Tygh, Tygh.$));<?php echo '</script'; ?>
>
