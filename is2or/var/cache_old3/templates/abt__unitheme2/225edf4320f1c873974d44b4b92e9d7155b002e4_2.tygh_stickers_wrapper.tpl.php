...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb21882e5f3_30049571',
...
function content_69afb21882e5f3_30049571 (\Smarty\Template $_smarty_tpl) {
...
$foreach35Backup = clone $_smarty_tpl->getVariable('position');
?>
...
$_smarty_tpl->assign('container_class', "ab-stickers-container__".$_prefixVariable27, false, NULL);?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                ...
                <?php
$_smarty_tpl->setVariable('position', $foreach35Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                <?php if ($_smarty_tpl->getValue('details_page') && $_smarty_tpl->getValue('sticker_display_place_key') === $_smarty_tpl->getValue('product_labels_place')) {?>
                    </div>
...
$foreach41Backup = clone $_smarty_tpl->getVariable('position');
?>
                    <?php $_smarty_tpl->assign('pos_counter', 0, false, NULL);?>
                    <?php ob_start();
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('str_replace')('.','_',$_smarty_tpl->getValue('sticker_display_place_key'))), ENT_QUOTES, 'UTF-8');
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                ...
                <?php
$_smarty_tpl->setVariable('position', $foreach41Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                <?php if ($_smarty_tpl->getValue('details_page') && $_smarty_tpl->getValue('sticker_display_place_key') === $_smarty_tpl->getValue('product_labels_place')) {?>
                    </div>
