...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb2186163a7_52964177',
...
function content_69afb2186163a7_52964177 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('label_text', $_prefixVariable9." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable10=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable10." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable11 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
...
$foreach28Backup = clone $_smarty_tpl->getVariable('var');
?>
...
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach28Backup);
}
...
$_smarty_tpl->assign('label_text', $_prefixVariable12." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable13=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable13." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable14 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['price'], false, NULL);?>
                <?php } else { ?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['clean_price'], false, NULL);?>
                <?php }?>
...
$_smarty_tpl->getVariable('var')->iteration++;
$_smarty_tpl->getVariable('var')->last = $_smarty_tpl->getVariable('var')->iteration === $_smarty_tpl->getVariable('var')->total;
$foreach30Backup = clone $_smarty_tpl->getVariable('var');
?>
                        <option value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->getValue('product')['selected_amount'] && ($_smarty_tpl->getValue('product')['selected_amount'] == $_smarty_tpl->getValue('var') || ($_smarty_tpl->getVariable('var')->last && !$_smarty_tpl->getValue('selected_amount')))) {
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach30Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                </select>
                <?php } else { ?>
