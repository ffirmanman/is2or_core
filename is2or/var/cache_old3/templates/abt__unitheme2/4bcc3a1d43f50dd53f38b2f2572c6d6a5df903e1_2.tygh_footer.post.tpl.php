...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69afb210dc6df4_49716444',
...
function content_69afb210dc6df4_49716444 (\Smarty\Template $_smarty_tpl) {
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->getValue('products'))."&redirect_url=".$_prefixVariable4)), ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->getValue('products'))."&redirect_url=".$_prefixVariable5)), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="ab-ec-comparison-modal__icon cm-confirm cm-dialog-closer ty-icon-trashcan cm-tooltip" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("clear_list", [], $_smarty_tpl->getSmarty()->getLanguage());?>
"></a></li><?php
}
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->getValue('products'))."&redirect_url=".$_prefixVariable6)), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="ab-ec-comparison-modal__icon cm-confirm cm-dialog-closer ty-icon-trashcan cm-tooltip" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("clear_list", [], $_smarty_tpl->getSmarty()->getLanguage());?>
"></a><?php }?></li><?php
$_from = $_smarty_tpl->getSmarty()->getRuntime('Foreach')->init($_smarty_tpl, $_smarty_tpl->getValue('comparison_lists'), 'comparison_list');
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('fn_url')("ab__extended_comparison_wishlist.clear_list?product_ids=".((string)$_smarty_tpl->getValue('products'))."&redirect_url=".$_prefixVariable7)), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="ab-ec-comparison-modal__icon cm-confirm cm-dialog-closer ty-icon-trashcan cm-tooltip" title="<?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("clear_list", [], $_smarty_tpl->getSmarty()->getLanguage());?>
"></a></li><?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?></ul><!--account_info_ab__extended_comparison_wishlist_groups--></div><?php }
