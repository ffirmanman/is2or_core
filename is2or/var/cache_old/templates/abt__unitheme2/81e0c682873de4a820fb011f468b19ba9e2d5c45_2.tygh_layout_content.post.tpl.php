...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69ada1ef1833a8_32786776',
...
function content_69ada1ef1833a8_32786776 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('tpl_search_similar_button', $_prefixVariable13, false, NULL);?>
    <?php echo '<script'; ?>
...
$_smarty_tpl->assign('tpl_search_similar_button', $_prefixVariable14, false, NULL);?>
    <?php echo '<script'; ?>
>(function(_, $) {$.extend(_.abt__ut2.templates, {search_similar_button: `<?php echo strtr((string)$_smarty_tpl->getSmarty()->getModifierCallback('trim')($_smarty_tpl->getValue('tpl_search_similar_button')), array("\\" => "\\\\", "'" => "\\'", "\"" => "\\\"", "\r" => "\\r", 
						"\n" => "\\n", "</" => "<\/", "<!--" => "<\!--", "<s" => "<\s", "<S" => "<\S",
						"`" => "\\`", "\${" => "\\\$\{"));?>
