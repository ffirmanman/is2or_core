...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69ad94ff79b669_81079672',
...
function content_69ad94ff79b669_81079672 (\Smarty\Template $_smarty_tpl) {
...
echo htmlspecialchars((string) ($_smarty_tpl->getValue('obj_id')), ENT_QUOTES, 'UTF-8');?>
"><span><i class="ut2-icon-use_icon_cart"></i><bdi><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('out_of_stock_text')), ENT_QUOTES, 'UTF-8');?>
</bdi></span></button><?php }
...
$_smarty_tpl->assign('label_text', $_prefixVariable13." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable14=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable14." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable15 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
...
$foreach36Backup = clone $_smarty_tpl->getVariable('var');
?>
...
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach36Backup);
}
...
?>
        <?php if ($_smarty_tpl->getValue('min_qty') && $_smarty_tpl->getValue('product')['min_qty']) {?>
            <p class="ty-min-qty-description"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("text_cart_min_qty", array("[product]"=>$_smarty_tpl->getValue('product')['product'],"[quantity]"=>$_smarty_tpl->getValue('product')['min_qty']), $_smarty_tpl->getSmarty()->getLanguage());?>
.</p>
        <?php }?>
    <?php $_block_repeat=false;
...
$_smarty_tpl->assign('label_text', $_prefixVariable16." <bdi>".((string)$_smarty_tpl->getValue('product')['discount_prc'])."%</bdi>", false, NULL);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("save_discount", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable17=ob_get_clean();
$_smarty_tpl->assign('label_text', $_prefixVariable17." <bdi>".((string)$_smarty_tpl->getValue('product')['list_discount_prc'])."%</bdi>", false, NULL);?>
                <?php }?>
...
if ($_smarty_tpl->getValue('auth')['tax_exempt'] === $_prefixVariable18 || !$_smarty_tpl->getValue('product')['clean_price']) {?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['price'], false, NULL);?>
                <?php } else { ?>
                    <?php $_smarty_tpl->assign('price', $_smarty_tpl->getValue('product')['clean_price'], false, NULL);?>
                <?php }?>
...
$_smarty_tpl->getVariable('var')->iteration++;
$_smarty_tpl->getVariable('var')->last = $_smarty_tpl->getVariable('var')->iteration === $_smarty_tpl->getVariable('var')->total;
$foreach38Backup = clone $_smarty_tpl->getVariable('var');
?>
                        <option value="<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
" <?php if ($_smarty_tpl->getValue('product')['selected_amount'] && ($_smarty_tpl->getValue('product')['selected_amount'] == $_smarty_tpl->getValue('var') || ($_smarty_tpl->getVariable('var')->last && !$_smarty_tpl->getValue('selected_amount')))) {
$_smarty_tpl->assign('selected_amount', true, false, NULL);?>selected="selected"<?php }?>><?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('var')), ENT_QUOTES, 'UTF-8');?>
                    ...
                    <?php
$_smarty_tpl->setVariable('var', $foreach38Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                </select>
                <?php } else { ?>
