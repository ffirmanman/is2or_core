...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69ada1ee00f251_41869666',
...
function content_69ada1ee00f251_41869666 (\Smarty\Template $_smarty_tpl) {
...
if ($_smarty_tpl->getValue('product')['promotions']) {?>
    ...
    <?php if ($_smarty_tpl->getValue('promotion')) {?>
        <div class="ab__deal_of_the_day pd-dp">
            <div<?php if ($_smarty_tpl->getValue('promotion')['to_date'] && $_smarty_tpl->getValue('promotion')['to_date'] > time()) {?> class="col1"<?php }?>>
                                ...
                                <div class="ab__dotd_promotion <?php if ($_smarty_tpl->getValue('promotion')['ab__dotd_expired']) {?>action-is-over<?php }?>">
                                    <div class="row-fluid ab__dotd_promotion-main_info">
                                        <?php if ($_smarty_tpl->getValue('promotion')['image']) {?>
                                            <div class="span8 ab__dotd_promotion-image" style="aspect-ratio: 2/1.2;background-size: 100%;background-repeat: no-repeat;background-image: url('<?php echo htmlspecialchars((string) ($_smarty_tpl->getValue('promotion')['image']['icon']['image_path']), ENT_QUOTES, 'UTF-8');?>
');">
                                            </div>
                                        <?php }?>
                                        <div class="span8">
