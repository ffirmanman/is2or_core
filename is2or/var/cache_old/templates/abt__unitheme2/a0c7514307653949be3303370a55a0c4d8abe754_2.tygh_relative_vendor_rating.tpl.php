...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69ad960736ef81_43510914',
...
function content_69ad960736ef81_43510914 (\Smarty\Template $_smarty_tpl) {
...
echo $_smarty_tpl->getSmarty()->getFunctionHandler('include_ext')->handle(array('file'=>"common/icon.tpl",'class'=>"ty-icon-vendor-rating ty-vendor-rating-icon ty-vendor-rating-icon--bronze",'title'=>$_prefixVariable35.": ".((string)$_smarty_tpl->getValue('rating'))."%"), $_smarty_tpl);?>
...
echo $_smarty_tpl->getSmarty()->getFunctionHandler('include_ext')->handle(array('file'=>"common/icon.tpl",'class'=>"ty-icon-vendor-rating ty-vendor-rating-icon ty-vendor-rating-icon--silver",'title'=>$_prefixVariable36.": ".((string)$_smarty_tpl->getValue('rating'))."%"), $_smarty_tpl);?>

        <?php } elseif ($_smarty_tpl->getValue('rating') >= $_smarty_tpl->getValue('addons')['vendor_rating']['gold_rating_lower_limit']) {?>
            <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")('vendor_rating.vendor_rating', [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable37=ob_get_clean();
echo $_smarty_tpl->getSmarty()->getFunctionHandler('include_ext')->handle(array('file'=>"common/icon.tpl",'class'=>"ty-icon-vendor-rating ty-vendor-rating-icon ty-vendor-rating-icon--gold",'title'=>$_prefixVariable37.": ".((string)$_smarty_tpl->getValue('rating'))."%"), $_smarty_tpl);?>
