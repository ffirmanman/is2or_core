...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69ad94ffa40e79_63020536',
...
function content_69ad94ffa40e79_63020536 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable23.".", false, NULL);
...
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable24.".", false, NULL);
}
...
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable25.".", false, NULL);
} elseif ($_smarty_tpl->getValue('button')) {?>
    <?php ob_start();
echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("product_reviews.click_to_see_reviews", [], $_smarty_tpl->getSmarty()->getLanguage());
$_prefixVariable26=ob_get_clean();
$_smarty_tpl->assign('title', ((string)$_smarty_tpl->getValue('title')).". ".$_prefixVariable26.".", false, NULL);
}
if ($_smarty_tpl->getValue('link') === true) {?>
    <?php $_smarty_tpl->assign('link', "products.view?product_id=".((string)$_smarty_tpl->getValue('product')['product_id'])."&selected_section=product_reviews#product_reviews", false, NULL);
}?>
