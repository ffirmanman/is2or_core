...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69aea29bde3cb0_55382736',
...
function content_69aea29bde3cb0_55382736 (\Smarty\Template $_smarty_tpl) {
$_smarty_current_dir = '/var/www/is2or/design/themes/abt__unitheme2/templates/blocks/checkout';
\Tygh\Languages\Helper::preloadLangVars(array('products_amount','items','amount','shipping','including_discount','order_discount','payment_surcharge','taxes','included','order_total','points_lowercase','coupon','products_amount','items','amount','shipping','including_discount','order_discount','payment_surcharge','taxes','included','order_total','points_lowercase','coupon'));
...
?></span>
            ...
            <?php if ($_smarty_tpl->getValue('cart')['taxes']) {?>
                <tr>
                    <td colspan="2" class="ty-checkout-summary__item ut2-checkout-summary__item_taxes-title"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback("__")("taxes", [], $_smarty_tpl->getSmarty()->getLanguage());?>
:</td>
                </tr>
                <?php
