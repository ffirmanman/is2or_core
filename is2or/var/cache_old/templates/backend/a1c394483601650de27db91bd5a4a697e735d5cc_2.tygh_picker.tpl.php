...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69ae46593e88f7_70075543',
...
function content_69ae46593e88f7_70075543 (\Smarty\Template $_smarty_tpl) {
...
$_smarty_tpl->renderSubTemplate("tygh:pickers/storefronts/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('picker_id'=>"object_picker_advanced_".((string)$_smarty_tpl->getValue('picker_id')),'data_id'=>"om",'no_container'=>$_smarty_tpl->getValue('no_container'),'icon'=>"icon-reorder",'but_text'=>$_prefixVariable3,'show_but_text'=>false,'view_mode'=>"button",'meta'=>"object-picker__advanced-btn object-picker__advanced-btn--storefronts ".((string)$_smarty_tpl->getValue('object_picker_advanced_btn_class'))), (int) 0, $_smarty_current_dir);
?>
            </div>
        <?php }?>
...
echo htmlspecialchars((string) ($_smarty_tpl->getSmarty()->getModifierCallback('to_json')(array(array("id"=>0,"text"=>$_prefixVariable4,"data"=>array("name"=>$_prefixVariable5))))), ENT_QUOTES, 'UTF-8');?>
"
                    <?php }?>
...
$_smarty_tpl->renderSubTemplate("tygh:views/storefronts/components/picker/item.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('type'=>"selection",'title_pre'=>$_prefixVariable6,'title_post'=>$_prefixVariable7), (int) 0, $_smarty_current_dir);
?>
    </div>
<?php echo '</script'; ?>
>
