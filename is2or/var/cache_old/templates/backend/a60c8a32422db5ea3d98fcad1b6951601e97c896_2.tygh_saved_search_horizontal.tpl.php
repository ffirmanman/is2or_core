...
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.3',
  'unifunc' => 'content_69aed9cd713fc2_93452733',
...
function content_69aed9cd713fc2_93452733 (\Smarty\Template $_smarty_tpl) {
...
$foreach6Backup = clone $_smarty_tpl->getVariable('view_prepare');
?>
...
$_smarty_tpl->assign('views_prepare', $_tmp_array, false, NULL);?>
    <?php
$_smarty_tpl->setVariable('view_prepare', $foreach6Backup);
}
...
$foreach7Backup = clone $_smarty_tpl->getVariable('view');
?>
...
"
                    ...
                    <?php }?>
                <?php
$_smarty_tpl->setVariable('view', $foreach7Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
            <?php }?>
...
$_smarty_tpl->getVariable('view')->iteration++;
$foreach8Backup = clone $_smarty_tpl->getVariable('view');
?>
...
echo htmlspecialchars((string) ($_smarty_tpl->getValue('view')['wrapper_class']), ENT_QUOTES, 'UTF-8');
                        ...
                        <?php
$_smarty_tpl->setVariable('view', $foreach8Backup);
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
                    </ul>
                </li>
