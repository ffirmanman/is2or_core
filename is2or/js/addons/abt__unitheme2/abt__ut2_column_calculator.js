...
const fn_debounced__catalogSubmenuNotCascading2ndListColumnFilling = utility__debounceUnderscore(fn__catalogSubmenuNotCascading2ndListColumnFilling, 200);
...
const $menu = $(this);
if ($menu.closest(".menu-vendor-categories").length > 0) return;
