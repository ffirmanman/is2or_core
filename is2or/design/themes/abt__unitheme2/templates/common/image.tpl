...
{if $image_data.image_path}
    ...
    <span class="ty-no-image" style="aspect-ratio: {$image_width|default:80} / {$image_height|default:80};">{include_ext file="common/icon.tpl" class="ty-icon-image ty-no-image__icon" title=__("no_image")}</span>
{/if}
{if $show_detailed_link}
