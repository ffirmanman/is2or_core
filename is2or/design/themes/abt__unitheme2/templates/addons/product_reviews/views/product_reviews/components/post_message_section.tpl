...
{if $message_body}
    ...
    <div class="ty-product-review-post-message-section ty-dl" data-ca-product-review="postMessageSection">
        ...
        {if $message_body}
            <div class="ty-product-review-post-message-section__body">
                {if $message_title}
                    <div class="ty-product-review-post-message-section__title  ty-strong ty-float-left">{$message_title nofilter}</div>
                {/if}
