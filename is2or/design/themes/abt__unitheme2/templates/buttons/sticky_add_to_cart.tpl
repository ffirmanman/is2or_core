...
{assign var="obj_prefix" value="stiky_panel_"}
    ...
    <div class="ut2-pb__sticky-add-to-cart_block">
        ...
        <div class="ut2-pb__sticky-add-to-cart_product">
            <div class="ut2-pb__sticky-add-to-cart_product-img">
                {include file="common/image.tpl" image_width=$image_width image_height=$image_height images=$product.main_pair no_ids=true lazy_load=false}
            </div>
