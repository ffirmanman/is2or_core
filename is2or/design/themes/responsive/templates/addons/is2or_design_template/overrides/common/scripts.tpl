...
{if $smarty.request.dispatch == "products.view"}
    <style>
        ...
        .ty-product-img.owl-carousel:hover .owl-controls, 
        .ty-product-img .owl-controls:hover {
        ...
        .owl-prev, .owl-next {
            ...
            align-items: center !important;     /* Centering Vertikal */
            justify-content: center !important;   /* Centering Horizontal */
        ...
        .cm-image-gallery-wrapper.ty-thumbnails_gallery {
            width: 350px !important;
            max-width: 350px !important;
        }
        
        .cm-image-gallery-wrapper .owl-wrapper-outer {
            width: 100% !important;
        }

        .ty-product-thumbnails.owl-carousel {
            overflow: visible !important;
        }

        .ty-product-thumbnails.owl-carousel .owl-wrapper-outer {
            overflow: visible !important;
            width: auto !important;
        }

        .ty-product-thumbnails.owl-carousel .owl-wrapper {
            width: auto !important;
            left: 0 !important;
        ...
        /* Sembunyikan total tombol panah di baris thumbnail (termasuk saat di-hover) */
        .ty-product-thumbnails.owl-carousel .owl-controls,
        .ty-product-thumbnails.owl-carousel:hover .owl-controls {
...
{script src="js/addons/is2or_design_template/phone_mask_override.js"}
