...
{* next tag utilizes node_cloning logic by setting data-type attribute to default when new item added by user *}
<span class="cm-select" style="display: none"><a onclick="$(this).closest('tr').find('td[data-type]').attr('data-type', 'default')"></a></span>
</div>
