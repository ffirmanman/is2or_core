...
<label for="page_ab__emd_alternative_name" class="control-label">{__("ab__emd_alternative_name")}</label>
<div class="controls">
<input class="input-large" type="text" name="page_data[ab__emd_alternative_name]" id="page_ab__emd_alternative_name" size="55" value="{$page_data.ab__emd_alternative_name}" />
</div>
</div>
</div>
{/if}