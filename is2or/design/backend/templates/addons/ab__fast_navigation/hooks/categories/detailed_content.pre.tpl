...
<div id="acc_addon_ab__fast_navigation" class="collapsed in{if !"ab__fast_navigation.manage"|fn_check_view_permissions} cm-hide-inputs{/if}">
...
<input type="checkbox" id="ab__fn_use_origin_image_{$id}" name="category_data[ab__fn_use_origin_image]" value="Y" {if $category_data['ab__fn_use_origin_image'] == "Y"}checked="checked"{/if} />
</div>
</div>
{** show_label **}
<div class="control-group">
...
<input type="checkbox" id="ab__fn_use_origin_image_{$id}" name="category_data[ab__fn_label_show]" value="Y" {if $category_data['ab__fn_label_show'] == "Y"}checked="checked"{/if} />
</div>
</div>
{** label **}
<div class="control-group">
