...
{$object_type = $id|default:'ab__mcd_items'}
...
<div class="object-picker {if $view_mode == "external"}object-picker--external{/if} object-picker__ab__mcd-outer {$meta}" data-object-picker="object_picker_{$picker_id}">
...
{/if}
<div class="object-picker__simple {if $type == "list"}object-picker__simple--list{/if} {if $show_advanced}object-picker__simple--advanced{/if} {$simple_class}">
<select {if $multiple}multiple {/if} name="{$input_name}"
class="cm-object-picker object-picker__select object-picker__select--products {$select_class}"
data-ca-object-picker-object-type="{$object_type}"
data-ca-object-picker-escape-html="false"
data-ca-object-picker-ajax-url="{"$ajax_url"|default:"ab__mcd_items.picker"|fn_url}"
...
data-ca-object-picker-predefined-variants="{[["id" => 0, "text" => {$empty_variant_text}, "data"=>["status" => "D","title"=>{$empty_variant_text},"description"=>""]]]|to_json}"
{/if}
id="{$id}"
>
...
{include file="addons/ab__multiple_cat_descriptions/picker/skeleton_external.tpl"}
</div
>{/foreach}
</div>
...
<div class="object-picker__result object-picker__result--ab__mcd {$result_class}">
{include file="addons/ab__multiple_cat_descriptions/picker/item_extended.tpl"
type="result"
...
<div class="cm-object-picker-object object-picker__selection-extended object-picker__selection-extended--ab__mcd">
{include file="addons/ab__multiple_cat_descriptions/picker/item_extended.tpl"
type="selection"
...
{else}
<script type="text/template" id="object_picker_selection_template_{$picker_id}" data-no-defer="true" data-no-execute="§">
<div class="cm-object-picker-object object-picker__selection object-picker__selection--ab__mcd">
{include file="addons/ab__multiple_cat_descriptions/picker/item.tpl"
type="selection"
title_pre={$selection_title_pre}
title_post={$selection_title_post}
empty_variant_text=$empty_variant_text
}
</div>
</script>
{/if}
