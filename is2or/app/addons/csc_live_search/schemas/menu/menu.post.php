...
$schema['top']['addons']['items']['csc_addons']['subitems']['csc_live_search'] = [
    'attrs' => [
        'class' => 'is-addon',
    ],
...
$schema['top']['administration']['items']['exim']['subitems']['csc_live_search'] = [
    'attrs' => [
        'class' => 'is-addon',
    ],
    'href' => 'csc_live_search.settings',
...
$schema['top']['administration']['items']['export_data']['subitems']['csc_live_search'] = [
    'href' => 'exim.export?section=csc_live_search',
    'position' => 5050,
];

$schema['top']['administration']['items']['import_data']['subitems']['csc_live_search'] = [
    'href' => 'exim.import?section=csc_live_search',
    'position' => 5050,
];

if (fn_allowed_for('MULTIVENDOR') && Registry::get('runtime.company_id')) {
    $schema['central']['website']['items']['cls.search_history'] = [
