...
class SimpleImage
{
     ...
     *
     * @param SimpleImage|string $overlay                 The image to overlay. This can be a filename, a data URI, or a SimpleImage object.
    ...
    public function resize($width = null, $height = null)
    {
        ...
        $transparentColor = imagecolorallocatealpha($newImage, 255, 255, 255, 0);
        imagecolortransparent($newImage, $transparentColor);
        imagefill($newImage, 0, 0, $transparentColor);
        imagecopyresampled(
            $newImage,
    ...
    public function text($text, $options, &$boundary = null)
    {
        ...
        // Convert px to pt (72pt per inch, 96px per inch)
