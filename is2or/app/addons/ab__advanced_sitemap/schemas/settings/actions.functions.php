...
function fn_settings_actions_addons_ab__advanced_sitemap(&$new_status, $old_status)
{
$new_status == 'A' && !(new ABXmlScheme(substr(__FUNCTION__, 27)))->checkDependencies() && $new_status = 'D';
$new_status == 'A' && fn_set_notification('W', __('warning'), __('ab__as.generate_map', ['[url]' => fn_url('ab__advanced_sitemap.manage')]));
}
