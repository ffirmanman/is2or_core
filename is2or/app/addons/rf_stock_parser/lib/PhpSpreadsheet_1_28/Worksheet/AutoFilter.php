...
class AutoFilter
{
    ...
    {
        if ($range !== '') {
            list(, $range) = Worksheet::extractSheetTitle(Validations::validateCellRange($range), true);
        }
            ...
            switch ($filterColumn->getFilterType()) {
                ...
                //    Test if we want to include blanks in our filter criteria
                    ...
                    //    Filter on date group values
                        ...
                        foreach ($ruleDataSet as $ruleValue) {
                            ...
                            if ((isset($ruleValue[Rule::AUTOFILTER_RULETYPE_DATEGROUP_MONTH]))
                            ...
                            if ((isset($ruleValue[Rule::AUTOFILTER_RULETYPE_DATEGROUP_HOUR]))
                            ...
                            if ((isset($ruleValue[Rule::AUTOFILTER_RULETYPE_DATEGROUP_SECOND]))
                ...
                case AutoFilter\Column::AUTOFILTER_FILTERTYPE_DYNAMICFILTER:
                    ...
                    //    We should only ever have one Dynamic Filter Rule anyway
                        ...
                        if (($dynamicRuleType == Rule::AUTOFILTER_RULETYPE_DYNAMIC_ABOVEAVERAGE)
