...
abstract class IOFactory
{
     ...
     *                           that should be loaded, but which won't be loaded by default, using these
     *                           values: IReader::LOAD_WITH_CHARTS - Include any charts that are defined in
     *                           the loaded file. IReader::READ_DATA_ONLY - Read cell values only, not
     *                           formatting or merge structure. IReader::IGNORE_EMPTY_CELLS - Don't load empty
     ...
     *                           list of Readers so it will only try the subset that you specify here. Values in
     *                           this list can be any of the constant values defined in the set
     *                           IOFactory::READER_*.
     */
