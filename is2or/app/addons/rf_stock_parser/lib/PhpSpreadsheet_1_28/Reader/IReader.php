...
interface IReader
{
     ...
     *                         self::LOAD_WITH_CHARTS    Load any charts that are
     *                         defined (if the Reader supports Charts)
     *                         self::READ_DATA_ONLY      Read only data, not
     *                         style or structure information, from the file
     *                         self::SKIP_EMPTY_CELLS    Don't read empty cells
     *                         (cells that contain a null value, empty string, or
