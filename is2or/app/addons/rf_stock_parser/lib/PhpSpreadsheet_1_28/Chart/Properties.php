...
abstract class Properties
{
     ...
     */
    public const EXCEL_COLOR_TYPE_STANDARD = ChartColor::EXCEL_COLOR_TYPE_STANDARD;
    /**
     * @deprecated 1.24 use constant from ChartColor instead
     */
    public const EXCEL_COLOR_TYPE_SCHEME = ChartColor::EXCEL_COLOR_TYPE_SCHEME;
    /**
     * @deprecated 1.24 use constant from ChartColor instead
     */
    public const EXCEL_COLOR_TYPE_ARGB = ChartColor::EXCEL_COLOR_TYPE_ARGB;
