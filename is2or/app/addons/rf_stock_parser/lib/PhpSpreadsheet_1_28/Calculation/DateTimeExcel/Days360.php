...
class Days360
{
     ...
     *                               becomes equal to the 30th of
     *                               the same month. If the ending
     *                               date is the last day of a month
     *                               and the starting date is
     *                               earlier than the 30th of a
     *                               month, the ending date becomes
     *                               equal to the 1st of the next
     *                               month; otherwise the ending
     *                               date becomes equal to the 30th
     *                               of the same month. TRUE:
     *                               European method. Starting dates
     *                               and ending dates that occur on
     *                               the 31st of a month become
     *                               equal to the 30th of the same
     *                               month. Or can be an array of
     *                               methods
     *
