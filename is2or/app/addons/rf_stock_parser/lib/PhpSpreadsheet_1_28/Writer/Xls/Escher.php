        ...
        switch (get_class($this->object)) {
            ...
            case SpContainer::class:
                ...
                if ($this->object->/* @scrutinizer ignore-call */ getStartCoordinates()) {
                    ...
                    // start coordinates
                    list($column, $row) = Coordinate::indexesFromString($this->object->/* @scrutinizer ignore-call */ getStartCoordinates());
                    $c1 = $column - 1;
                    $r1 = $row - 1;
                    ...
                    // end coordinates
                    list($column, $row) = Coordinate::indexesFromString($this->object->/* @scrutinizer ignore-call */ getEndCoordinates());
                    $c2 = $column - 1;
                    $r2 = $row - 1;
