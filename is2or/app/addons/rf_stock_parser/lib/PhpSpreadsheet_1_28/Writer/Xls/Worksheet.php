...
class Worksheet extends BIFFwriter
{
    ...
    public function close(): void
    {
        ...
        foreach ($phpSheet->getHyperLinkCollection() as $coordinate => $hyperlink) {
            list($column, $row) = Coordinate::indexesFromString($coordinate);
    ...
    private function writeMergedCells(): void
    {
        ...
        foreach ($mergeCells as $mergeCell) {
            ...
            list($firstColumn, $firstRow) = Coordinate::indexesFromString($first);
            list($lastColumn, $lastRow) = Coordinate::indexesFromString($last);
    ...
    private function writePanes(): void
    {
        ...
        list($column, $row) = Coordinate::indexesFromString($this->phpSheet->getFreezePane());
        $x = $column - 1;
        $y = $row - 1;

        list($leftMostColumn, $topRow) = Coordinate::indexesFromString($this->phpSheet->getTopLeftCell() ?? '');
