...
abstract class WizardAbstract
{
    ...
    protected function setReferenceCellForExpressions(string $conditionalRange): void
    {
        ...
        list($this->referenceCell) = $conditionalRange[0];

        list($this->referenceColumn, $this->referenceRow) = Coordinate::indexesFromString($this->referenceCell);
    }
    ...
    public static function reverseAdjustCellRef(string $condition, string $cellRange): string
    {
        ...
        list($referenceCell) = $conditionalRange[0];
        list($referenceColumnIndex, $referenceRow) = Coordinate::indexesFromString($referenceCell);
