        ...
        'actions' => [
            ...
            'items'    => [
                'delete_selected' => [
                    ...
                    'dispatch' => 'is2or_vendor_banks.m_delete',
                    'data'     => [
...
foreach ($selectable_statuses as $status => $status_name) {
    $item = [
        ...
        'dispatch' => 'is2or_vendor_banks.m_update_statuses',
        'data'     => [
            'action_attributes' => [
                'class'               => 'cm-ajax cm-post cm-ajax-send-form',
                'href'                => fn_url('is2or_vendor_banks.m_update_statuses?status=' . $status),
                'data-ca-target-id'   => 'pagination_contents',
                'data-ca-target-form' => '#vendor_banks_form',
            ],
        ],
        'position' => $position,
    ];
