...
function fn__getBrowserName(user_agent) {
...
window.g__browser_name = fn__getBrowserName(navigator.userAgent);
window.g_flag__is_firefox_android_browser = /^Linux a/.test(navigator.oscpu);
window.g_flag__is_chromium = !!window.chrome;
window.g_flag__is_full_screen = !!(document.fullscreenElement || document.mozFullScreenElement || document.webkitFullscreenElement || document.msFullscreenElement);
function fn__checkTouchScreenDevice() {
...
window.g_flag__is_touch_screen = fn__checkTouchScreenDevice();
window.g_flag__is_mobile_device = /Mobi/i.test(navigator.userAgent);
window.g_flag__is_mobile_device__1_alt = window.matchMedia('(pointer:coarse)').matches && !window.matchMedia('(pointer:fine)').matches && window.matchMedia('(hover:none)').matches;
window.g_flag__is_mobile_device__2_alt = typeof navigator.userAgentData !== 'undefined' && navigator.userAgentData != null && navigator.userAgentData.mobile;
window.g_flag__is_iPad_desktop_device = navigator.userAgent.includes('Mac') && window.g_flag__is_touch_screen && navigator.vendor != null && navigator.vendor.match(/Apple Computer, Inc./) && /Apple/.test(navigator.userAgent) && !/Edge/i.test(navigator.userAgent) && !window.MSStream;
window.g_flag__is_iPad_mobile_device = /iPad/i.test(navigator.userAgent) && navigator.vendor != null && navigator.vendor.match(/Apple Computer, Inc./) && /Apple/.test(navigator.userAgent) && !/Edge/i.test(navigator.userAgent) && !window.MSStream;
window.window.g_flag__is_iPad_device = window.g_flag__is_iPad_desktop_device || window.g_flag__is_iPad_mobile_device;
window.g_flag__is_iPhone_device = /iPhone|iPod/i.test(navigator.userAgent) && navigator.vendor != null && navigator.vendor.match(/Apple Computer, Inc./) && /Apple/.test(navigator.userAgent) && /Mobi/i.test(navigator.userAgent) && !/Edge/i.test(navigator.userAgent) && !window.MSStream;
window.g_flag__is_iOS_iPadOS_device = window.g_flag__is_iPad_device || window.g_flag__is_iPhone_device;
window.g_flag__is_iOS_device__alt = typeof navigator.standalone === 'boolean';
window.g_flag__is_android_device = navigator.userAgent.toLowerCase().includes('android');
window.g_flag__is_android_tablet_device = window.g_flag__is_android_device && !/Mobi/i.test(navigator.userAgent);
window.g_flag__is_android_phone_device = window.g_flag__is_android_device && /Mobi/i.test(navigator.userAgent);
window.g_flag__is_rtl = document.documentElement.getAttribute('dir') === 'rtl';
window.g_flag__is_devel_domain =
(window.location.href.indexOf('.test.abt.team') > -1) ||
(window.location.href.indexOf('192.168') > -1) ||
(window.location.href.indexOf('localhost') > -1);
window.rt__overall_top_stuck_height = 0;
window.g__ut2_top_panel_height = parseInt($(':root').css('--ut2-top-panel-height'));
window.g__ut2_header_1st_row_height = parseInt($(':root').css('--ut2-header-height'));
window.g__ut2_header_2nd_row_height_1 = parseInt($(':root').css('--ut2-header__2nd-row-_height-_1'));
window.g__ut2_header_2nd_row_height_2 = parseInt($(':root').css('--ut2-header__2nd-row-_height-_2'));
...
if (window.g_flag__is_iOS_device__alt) {
...
fn__catalogMenu();
fn__headerAndPanels();
fn__processHorizontallyScrollableContainer($(document.body));
fn__optimizeSubmitOrderButtonDisplay();
fn__stickyBottomPanel();
fn__unfoldEntireHeading();
fn__fixTemplateListMenu();
fn__customToggleTopPanelQuickLinksDropdown();
$(window).on('scroll.global', function (event) {
utility_debounced__getDropdownPopupTopClearanceToWindowEdge($('.top-menu-grid-vertical.ty-dropdown-box .ty-dropdown-box__title[id]'));
utility_debounced__getDropdownPopupTopClearanceToWindowEdge($('.ty-horizontal-product-filters-dropdown__wrapper'));
...
utility__clickOutsideElement('.ut2-horizontal-product-filters-dropdown', function (event, el) {
if (_.abt__ut2.device === 'desktop' && window.matchMedia('(max-width: 785px)').matches) {
$('.ty-horizontal-product-filters-dropdown__wrapper.open').trigger('click');
}
}, {relative_to: 'all'});
utility__clickOutsideElement('.b--pay-ship__select', function (event, el) {
let $checkbox = $(el).children('input[id^=open]');
let $btn_head = $(el).children('.b--pay-ship__opted');
if ($checkbox.prop('checked')) $btn_head.trigger('click');
});
$(document).on('click.copy_sku', '.ty-sku-item .ut2_copy', function () {
window.g_fn__copySkuTextToClipboard($(this).find('.ut2--sku-text'));
});
$(document).on('click.stop_propagation', '.js_stop-click-propagation', function(event) {
...
$(':root').css('--header-height', `${window.g__ut2_header_1st_row_height}px`);
...
header_2nd_row_height = window.g__ut2_header_2nd_row_height_1;
} else if (flag__is_header_allows_h_menu) {
header_2nd_row_height = window.g__ut2_header_2nd_row_height_2;
} else {
...
header_stuck_height = rt__header_1st_row_height + window.g__ut2_header_2nd_row_height_1;
} else {
...
if (mmq.matches) {
header_stuck_height = getRealtimeHeader1stRowHeight() + window.g__ut2_header_2nd_row_height_1;
} else {
...
if (flag__is_header_default) {
if (mmq__header_search_2nd_row_mode.matches) {
rt__header_stuck_height = rt__header_1st_row_height + window.g__ut2_header_2nd_row_height_1;
} else {
...
const product_id = $buy_panel_stuck_sentinel.length > 0 ? utility__getDigitsAtStringEnd($buy_panel_stuck_sentinel.attr('id')) : null;
...
fn_debounced_enclosed__keepTrackStickyBuyPanelSentinel();
} else {
fn_enclosed__keepTrackStickyBuyPanelSentinel();
}
});
fn_enclosed__keepTrackStickyBuyPanelSentinel();
const fn_debounced_enclosed__keepTrackStickyBuyPanelSentinel = utility__debounce_withLeadingTrailing(fn_enclosed__keepTrackStickyBuyPanelSentinel);
...
const fn_debounced__tweakProductStickyColumn = utility__debounceUnderscore(fn__tweakProductStickyColumn, 200);
...
let $combi_toggler = container.siblings('.ut2-sp-n');
if (flag) {
$combi_toggler.removeClass('open');
}
});
...
let $combi_popup = container;
let $combi_outside_wrapper = $combi_popup.parent();
let combi_outside_wrapper_position_class;
let $combi_scrollable;
let combi_scrollable_selector;
let $combi_page_overlay = $combi_popup.siblings('[class*="overlay"]');
let $combi_dropdown = $combi_toggler.parent();
let combi_dropdown__class_list;
let lockedPageScroll_abortController;
const flag__combi_is_h_filters = $combi_toggler.is('.ty-horizontal-product-filters-dropdown__wrapper');
...
const flag__combi_is_catalog_v_menu = $combi_dropdown.is('.top-menu-grid-vertical');
const flag__combi_is_fly_menu = $combi_toggler.is('.ut2-sp-n, .ut2-sp-f');
const flag__combi_is_filters_modal = $combi_dropdown.is('.ut2-filters');
const flag__combi_is_categories_modal = $combi_dropdown.is('.ut2-categories');
const flag__combi_has_outside_position = $combi_dropdown.hasClass('cm-abt--ut2-move-bottom') || $combi_outside_wrapper.hasClass('ut2-dropdown-outside-position');
const flag__combi_is_in_sticky_bottom_panel = $combi_dropdown.closest('.ut2-sticky-panel').length > 0;
if (flag__combi_is_h_filters) {
$combi_adjacent_h_filters = $combi_dropdown.siblings();
if (_.abt__ut2.device !== 'mobile') {
$combi_dropdown.addClass('js_popup_-invisible');
}
}
if (flag__combi_is_catalog_v_menu) {
$combi_scrollable = $combi_popup.find('.ut2-menu__list');
combi_scrollable_selector = '.ut2-menu__list';
}
if (flag__combi_is_fly_menu) {
$combi_toggler = container.siblings('.ut2-sp-n');
$combi_popup = container.siblings('.ut2-sw-w');
$combi_page_overlay = container;
$combi_scrollable = $combi_popup.find('.ut2-scroll');
combi_scrollable_selector = '.ut2-scroll';
}
if ($combi_dropdown.hasClass('cm-abt--ut2-move-bottom')) {
if (!$combi_dropdown.is('.lt-position, .rt-position')) {
if ($combi_dropdown.is(':first-child')) {
combi_outside_wrapper_position_class = 'lt-position';
} else {
combi_outside_wrapper_position_class = 'rt-position';
}
$combi_dropdown.addClass(combi_outside_wrapper_position_class);
}
combi_dropdown__class_list = $combi_dropdown[0].classList;
combi_dropdown__class_list.remove('cm-abt--ut2-move-bottom', 'ty-dropdown-box', 'ty-dropdown-box2');
$('#tygh_main_container').append($combi_popup);
$combi_popup.wrap('<div class="ut2-dropdown-outside-position ' + combi_dropdown__class_list + '"></div>').after($combi_page_overlay);
}
if (flag__combi_has_outside_position) {
$combi_outside_wrapper = $combi_popup.parent();
}
if (flag__combi_is_filters_modal) {
$combi_scrollable = $combi_popup.find('.ty-product-filters__wrapper');
combi_scrollable_selector = '.ty-product-filters__wrapper';
}
if (flag__combi_is_categories_modal) {
$combi_scrollable = $combi_popup.find('.ut2-subcategories');
combi_scrollable_selector = '.ut2-subcategories';
}
lockedPageScroll_abortController = $combi_toggler.data('locked_page_scroll_abort_controller');
setTimeout(function () {
if ($combi_toggler.hasClass('open')) {
$combi_popup.addClass('js_open');
...
if (_.abt__ut2.device !== 'mobile') {
fn_sub__processOpenedCombiDropdown($combi_toggler);
$combi_dropdown.removeClass('js_popup_-invisible');
}
}
...
if (lockedPageScroll_abortController != null) {
lockedPageScroll_abortController.abort();
}
lockedPageScroll_abortController = new AbortController();
$combi_toggler.data('locked_page_scroll_abort_controller', lockedPageScroll_abortController);
g_fn__offPageScroll(lockedPageScroll_abortController, $combi_scrollable.get(0), combi_scrollable_selector, $combi_popup.get(0));
}
if (flag__combi_is_catalog_v_menu) {
$('html').addClass('js_catalog-v-menu_-open');
utility__getDropdownPopupTopClearanceToWindowEdge($combi_toggler);
}
if (flag__combi_is_fly_menu) {
$('html').addClass('js_fly-menu_-open js_side-modal_-open');
}
if (flag__combi_has_outside_position && !$combi_popup.is('.js_forced-show')) {
$combi_popup.addClass('js_forced-show');
...
if ($combi_toggler.hasClass('open')) {
$combi_toggler.trigger('click');
}
return false;
});
}
} else {
$combi_popup.removeClass('js_open');
...
$combi_toggler
.data('flag__opened_combi_dropdown__processed', false)
.attr('data-opened-combi-dropdown--processed', false);
}
}
if (flag__combi_is_catalog_v_menu || flag__combi_is_fly_menu || flag__combi_is_filters_modal || flag__combi_is_categories_modal) {
...
if (flag__combi_is_catalog_v_menu || flag__combi_is_fly_menu) {
if (lockedPageScroll_abortController != null) {
g_fn__offOffPageScroll(lockedPageScroll_abortController);
}
}
if (flag__combi_is_catalog_v_menu) {
...
if (flag__combi_is_fly_menu) {
$combi_popup.on('transitionend', function () {
...
$(this).off('transitionend');
$combi_popup.removeClass('js_forced-show');
...
if (flag__combi_is_in_sticky_bottom_panel) {
const combi_popup_id = $combi_popup.attr('id');
const $combi_opener = $(`#sw_${combi_popup_id}`).add(`#on_${combi_popup_id}`).first();
$combi_popup.removeAttr('style');
if (!flag) {
g_fn__lockPage();
$('html').addClass('js_modal_-open js_sbp_dropdownbox_modal_-open');
$combi_popup.removeClass('hidden');
if ($combi_popup.is('#dropdown_sticky_item_search')) {
$combi_opener.addClass('open');
}
} else {
$combi_opener.removeClass('open');
$combi_popup.addClass('hidden');
g_fn__unLockPage();
setTimeout(function () {
$('html').removeClass('js_modal_-open js_sbp_dropdownbox_modal_-open');
}, 200);
}
}
...
function g_fn__offOffPageScroll(lockedPageScroll_abortController) {
lockedPageScroll_abortController.abort();
$(window).off('.disable_scroll');
}
window.g_fn__offOffPageScroll = g_fn__offOffPageScroll;
function g_fn__offPageScroll(lockedPageScroll_abortController, el__scrollable_exception, scrollable_exception_selector, el__scrollable_exception_context) {
...
listener_option = {
passive: false,
signal: lockedPageScroll_abortController.signal,
}
...
window.g_fn__offPageScroll = g_fn__offPageScroll;


function g_fn__lockPage() {
if (window.g_mmq__mobile.matches) {
if (!$('body').is('.js_page-state_-locked')) {
$('body')
...
.addClass('js_page-state_-locked');
}
}
}
window.g_fn__lockPage = g_fn__lockPage;
function g_fn__unLockPage() {
if (window.g_mmq__mobile.matches) {
if ($('body').is('.js_page-state_-locked')) {
setTimeout(function () {
$('body').removeAttr('style');
$(document).scrollTop($('body').data('page_scroll_top'));
$('body').removeData('scroll_top').removeClass('js_page-state_-locked');
}, 0);
}
}
}
window.g_fn__unLockPage = g_fn__unLockPage;
...
const fn_debounced__getHorizontalMenuPopupTopClearanceToWindowEdge = utility__debounceUnderscore(fn__getHorizontalMenuPopupTopClearanceToWindowEdge, 200);
...
if (utility__checkIfElementIsFullyInViewport($h_menu__popup__offset_parent)) {
...
function fn__customToggleTopPanelQuickLinksDropdown() {
const dropdown_selector = '.top-quick-links .ty-text-links__subitems.ty-level-0';
$(document).on('click.custom_toggle_quick_links_dropdown', dropdown_selector,
function () {
if (window.matchMedia('(min-width: 1025px)').matches) {
let $dropdown = $(this);
$dropdown.toggleClass('js_open');
}
});
utility__clickOutsideElement(dropdown_selector, function (event, el) {
if (window.matchMedia('(min-width: 1025px)').matches) {
$(el).removeClass('js_open');
}
});
}
...
if (window.g_flag__is_firefox_android_browser) {
...
function fn__fixTemplateListMenu() {
let dom__popup = document.querySelector('body > .ty-template-list-menu');
if (dom__popup && !dom__popup.__tplListMenuObs && ('MutationObserver' in window)) {
let fn_callback__templateListMenuObs = function (mutationList, observer) {
let popup_inline_top = dom__popup.style.top;
let popupComputedStyle = getComputedStyle(dom__popup);
let popup_display = popupComputedStyle.display;
let popup_computed_top = popupComputedStyle.top;
let popup_top = popup_inline_top && popup_inline_top !== 'auto' ? popup_inline_top : popup_computed_top;
let popup_top_num = parseFloat(popup_top);
if (popup_display === "none") {
dom__popup.classList.remove('js_open');
dom__popup.classList.remove('js_corrected-top');
} else {
dom__popup.classList.add('js_open');
dom__popup.classList.toggle('js_corrected-top', Number.isFinite(popup_top_num) && popup_top_num < 0);
}
}
let fn_debounced_callback__templateListMenuObs = utility__debounce_withLeadingTrailing(fn_callback__templateListMenuObs, 50);
let templateListMenuObsOptions = {
attributes: true,
attributeFilter: ['style']
}
let templateListMenuObserver = new MutationObserver(fn_debounced_callback__templateListMenuObs);
templateListMenuObserver.observe(dom__popup, templateListMenuObsOptions);
dom__popup.__tplListMenuObs = templateListMenuObserver;
}
}
...
function fn__processHorizontallyScrollableContainer($context) {
$('.ut2-scroll-content', $context).each(function () {
let $scrollable_container = $(this);
if ($scrollable_container.data('flag__horizontally_scrollable_container__processed') === true) return;
...
$scrollable_container.find('.cm-combination.open').trigger('click');
};
...
.data('flag__horizontally_scrollable_container__processed', true)
.attr('data-horizontally-scrollable-container--processed', true);
});
}


function fn_sub__processOpenedCombiDropdown($combi_toggler) {
if (_.abt__ut2.device === 'mobile') return;
if ($combi_toggler.data('flag__opened_combi_dropdown__processed') === true) return;
let $combi_popup = $combi_toggler.siblings('.cm-popup-box, .ty-dropdown-box__content, .ty-horizontal-product-filters-dropdown__content');
let $combi_dropdown = $combi_toggler.parent();
let flag__combi_is_h_filters = $combi_toggler.is('.ty-horizontal-product-filters-dropdown__wrapper');
let fn__positionTracker = $combi_toggler.data('position_tracker');
let fn_callback__positionTracker = $combi_toggler.data('position_tracker_callback');
if (flag__combi_is_h_filters) {
$combi_popup.addClass('js_open');
if (fn_callback__positionTracker == null) {
fn_callback__positionTracker = function (elem__toggler, flag__distanceChange, distanceLength, flag__is_initial_call) {
let elem__popup = elem__toggler.parentElement.querySelector('.ty-horizontal-product-filters-dropdown__content');
if (!elem__popup || !elem__popup.isConnected) return;
utility__pairPopupWithToggler(elem__toggler, elem__popup, flag__distanceChange, distanceLength);

}
$combi_toggler.data('position_tracker_callback', fn_callback__positionTracker);
}
if (fn__positionTracker == null) {
fn__positionTracker = utility_rt__trackDistanceChangeToViewportBoundary($combi_toggler.get(0), fn_callback__positionTracker);
...
utility__getDropdownPopupTopClearanceToWindowEdge($combi_toggler);
if (flag__combi_is_h_filters) {
fn_sub__computeHfilterPopupSubtractedSpace($combi_popup);
}
$combi_toggler
.data('flag__opened_combi_dropdown__processed', true)
.attr('data-opened-combi-dropdown--processed', true);
}


$.ceEvent('on', 'ce.ajaxdone', function (elms, inline_scripts, params, data, text) {
if (!(params && params.result_ids)) return;
if (params.result_ids.includes('product_detail_page')) {
fn_sub__setUpStickyBuyPanel();
}
fn_enclosed__processUpdatedContainersContent();
function fn_enclosed__processUpdatedContainersContent() {
let arr__result_masks = params.result_ids.split(',').map(result_id => result_id.trim());
let arr__result_containers = [];
arr__result_masks.forEach(function (result_mask) {
let result_selector;
if (result_mask.endsWith('*')) {
result_selector = '[id^="' + result_mask.slice(0, -1) + '"]';
} else {
result_selector = '#' + result_mask;
}
$(result_selector).each(function () {
arr__result_containers.push(this);
});
});
$(arr__result_containers).each(function () {
let $result_container = $(this);
fn__processHorizontallyScrollableContainer($result_container);
$result_container.find('.cm-combination.open').each(function () {
fn_sub__processOpenedCombiDropdown($(this));
});
});
}
});
...
function utility__wasContainerUpdatedViaAjax(params, desired_id) {
if (!(params && params.result_ids)) return;
let arr__result_masks = params.result_ids.split(',').map(result_id => result_id.trim());
return arr__result_masks.some(result_mask => result_mask.endsWith('*') ? desired_id.startsWith(result_mask.slice(0, -1)) : desired_id === result_mask);
}
window.utility__wasContainerUpdatedViaAjax = utility__wasContainerUpdatedViaAjax;


function utility__debugResultContainers(params) {
if (!window.console || !console.groupCollapsed) return;
let arr__updated_containers = [];
$('[id]').each(function () {
let id = this.id;
if (utility__wasContainerUpdatedViaAjax(params, id)) {
arr__updated_containers.push(this);
}
});
if (!arr__updated_containers.length) return;
console.groupCollapsed('%c[ce.ajaxdone]%c Containers updated', 'color:#4CAF50;font-weight:bold;', 'color:#555;');
console.log('Masks result_ids:', params.result_ids);
console.log('Matched containers count:', arr__updated_containers.length);
if (arr__updated_containers.length) {
console.table(
arr__updated_containers.map(function (el) {
...
console.groupEnd();
arr__updated_containers.forEach(function (el) {
$(el).css('outline', '3px solid red');
});
}
window.utility__debugResultContainers = utility__debugResultContainers;

function utility__checkIfElementIsFullyInViewport($element) {
if ($element.offset().top >= $(window).scrollTop() && $element.offset().top + $element.outerHeight() < $(window).scrollTop() + $(window).height()) {
return true;
}
}
window.utility__checkIfElementIsFullyInViewport = utility__checkIfElementIsFullyInViewport;
function utility__isElementVisible(elem, options = {}) {
const { ignore_opacity = false } = options;
if (!elem || !elem.isConnected) return false;
let {display, visibility, opacity, position} = window.getComputedStyle(elem);
let rect = elem.getBoundingClientRect();
if (
(elem !== document.body && !elem.offsetParent && position !== 'fixed') ||
display === 'none' ||
visibility === 'hidden' ||
visibility === 'collapse' ||
(!ignore_opacity && parseFloat(opacity) === 0) ||
(rect.width <= 0 && rect.height <= 0)
) return false;
return true;
}
window.utility__isElementVisible = utility__isElementVisible;
function utility__getDigitsAtStringEnd(str) {
let final_digits = str.match(/\d+$/);
return final_digits ? Number(final_digits[0]) : null;
}
window.utility__getDigitsAtStringEnd = utility__getDigitsAtStringEnd;
function utility__onceCall(func) {
var called = false;
return function() {
if (!called) {
called = true;
...
window.utility__onceCall = utility__onceCall;
function utility__pairPopupWithToggler(elem__toggler, elem__popup, flag__distanceChange, distanceLength) {
let {position} = window.getComputedStyle(elem__popup);
if (position !== 'fixed') return;
let elem__dropdown = elem__toggler.parentElement;
if (flag__distanceChange.bottom) {
$(elem__dropdown).css('--js_rt_popup-dist-_top', roundTo1Decimal(elem__toggler.getBoundingClientRect().bottom) + 'px');
}
if (flag__distanceChange.inline_start) {
$(elem__dropdown).css('--js_rt_popup-dist-_inline-start', distanceLength.inline_start + 'px');
}
}
window.utility__pairPopupWithToggler = utility__pairPopupWithToggler;
function utility_rt__trackDistanceChangeToViewportBoundary(elem__tracking_target, callback) {
let flag__is_rtl = getComputedStyle(document.documentElement).direction === 'rtl';
let flag__tracker_is_active = false;
let raf_id = null;
let flag__tracking_target_was_visible = false;
let flag__is_initial_call = true;
let priorDistanceLength = null;
function comparePosition() {
if (!flag__tracker_is_active) return;
if (!elem__tracking_target?.isConnected) {
disable();

return;
}
if (!utility__isElementVisible(elem__tracking_target, { ignore_opacity: true })) {
flag__tracking_target_was_visible = false;
} else {
if (!flag__tracking_target_was_visible) {
flag__tracking_target_was_visible = true;
if (!priorDistanceLength) {
flag__is_initial_call = true;
priorDistanceLength = null;
}
}
let currentRect = elem__tracking_target.getBoundingClientRect();
let { width: viewport_width, height: viewport_height } = getViewportSize();
let currentDistanceLength = {
top: roundTo1Decimal(currentRect.top),
right: roundTo1Decimal(viewport_width - currentRect.right),
bottom: roundTo1Decimal(viewport_height - currentRect.bottom),
left: roundTo1Decimal(currentRect.left)
};
let flag__distanceChange = {};
currentDistanceLength.inline_start = flag__is_rtl ? currentDistanceLength.right : currentDistanceLength.left;
currentDistanceLength.inline_end = flag__is_rtl ? currentDistanceLength.left : currentDistanceLength.right;
if (!priorDistanceLength) {
flag__distanceChange.top = flag__distanceChange.right = flag__distanceChange.inline_end =
flag__distanceChange.bottom = flag__distanceChange.left = flag__distanceChange.inline_start = true;
} else {
flag__distanceChange.top = currentDistanceLength.top !== priorDistanceLength.top;
flag__distanceChange.right = currentDistanceLength.right !== priorDistanceLength.right;
flag__distanceChange.inline_end = currentDistanceLength.inline_end !== priorDistanceLength.inline_end;
flag__distanceChange.bottom = currentDistanceLength.bottom !== priorDistanceLength.bottom;
flag__distanceChange.left = currentDistanceLength.left !== priorDistanceLength.left;
flag__distanceChange.inline_start = currentDistanceLength.inline_start !== priorDistanceLength.inline_start;
}
if (
flag__is_initial_call ||
flag__distanceChange.top ||
flag__distanceChange.right ||
flag__distanceChange.inline_end ||
flag__distanceChange.bottom ||
flag__distanceChange.left ||
flag__distanceChange.inline_start
) {
try {
callback(elem__tracking_target, flag__distanceChange, currentDistanceLength, flag__is_initial_call);
} catch (err) {
console.error('position tracker callback error: ', err);
}
priorDistanceLength = { ...currentDistanceLength };
flag__is_initial_call = false;
}
}
raf_id = requestAnimationFrame(comparePosition);
}
function enable() {
if (flag__tracker_is_active) return;
flag__tracker_is_active = true;
flag__tracking_target_was_visible = false;
flag__is_initial_call = true;
priorDistanceLength = null;
comparePosition();
...
window.utility_rt__trackDistanceChangeToViewportBoundary = utility_rt__trackDistanceChangeToViewportBoundary;
...
function roundTo1Decimal(digit) {
return Math.round(digit * 10) / 10;
}
window.roundTo1Decimal = roundTo1Decimal;
function utility__clickOutsideElement(selector, callback, options = {}) {
if (typeof selector !== 'string' || typeof callback !== 'function') return null;
selector = selector.trim();
let { relative_to = 'each' } = options;
if (!['each', 'all'].includes(relative_to)) relative_to = 'each';
let flag__is_enabled = false;
let listenerOptions = {capture: true, passive: true};
let time__last_event = 0;
let time__debounce_delay = window.g_flag__is_touch_screen ? 400 : 100;
let api = {
enable: function () {
if (flag__is_enabled) return;
flag__is_enabled = true;
document.addEventListener('click', handlerOnClick, listenerOptions);
},
disable: function () {
if (!flag__is_enabled) return;
document.removeEventListener('click', handlerOnClick, listenerOptions);
flag__is_enabled = false;
}
};
api.enable();
return api;
...
if (!flag__is_enabled) return;
let time__now = Date.now();
if (time__now - time__last_event < time__debounce_delay) return;
time__last_event = time__now;
if (relative_to === 'each') {
let dom__elems = document.querySelectorAll(selector);
if (!dom__elems.length) return;
dom__elems.forEach(function(dom__el) {
if (!dom__el.contains(event.target)) {
safeCallback(event, dom__el);
}
});
} else if (!event.target.closest(selector)) {
safeCallback(event, null);
}
}
...
console.error(`[utility__clickOutsideElement] Error in callback for selector "${selector}":`, err);
}
}
}
window.utility__clickOutsideElement = utility__clickOutsideElement;
function utility__debounceUnderscore(func, wait, leading) {
let timeout;
...
window.utility__debounceUnderscore = utility__debounceUnderscore;
function utility__debounce_withLeadingTrailing(func, wait = 200, options = {}) {
...
lastContext = this;
lastCallTime = now;
const shouldCallLeading = options.leading && !isLeadingInvoked;
clearTimeout(timeout);
...
window.utility__debounce_withLeadingTrailing = utility__debounce_withLeadingTrailing;
function utility__throttle_withLeadingTrailing(func, wait = 50, options = {}) {
...
lastArgs = args;
lastContext = this;
if (!lastInvoke && options.leading === false) {
lastInvoke = now;
}
...
window.utility__throttle_withLeadingTrailing = utility__throttle_withLeadingTrailing;
function utility__getDropdownPopupTopClearanceToWindowEdge($dropdown_btn_head) {
...
if (utility__checkIfElementIsFullyInViewport($dropdown_popup__offset_parent)) {
...
window.utility__getDropdownPopupTopClearanceToWindowEdge = utility__getDropdownPopupTopClearanceToWindowEdge;
window.utility_debounced__getDropdownPopupTopClearanceToWindowEdge = utility__debounceUnderscore(utility__getDropdownPopupTopClearanceToWindowEdge, 200);
function utility__keepTrackPageScrollMetrics() {
