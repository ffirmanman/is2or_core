...
var ab_lc_time = 300;
$(document).on('click', '.ab-lc-group .show-hidden-items-level-2, .ab-lc-landing .show-hidden-items-level-2', function() {
...
$(document).on('click', '.ab-lc-group li[data-subcategories="Y"] > a, .ab-lc-landing li[data-subcategories="Y"] > a', function() {
