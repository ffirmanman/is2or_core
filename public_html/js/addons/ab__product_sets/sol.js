...
$closeButton = $('<a href="#" class="sol-close"/>').html(this.config.texts.close).click(function (e) {
self.close();
e.preventDefault();
return false;
}),
...
this.$actionButtons = $('<div class="sol-action-buttons"/>').append($selectAllButton).append($closeButton).append($deselectAllButton).append('<div class="sol-clearfix"/>');
