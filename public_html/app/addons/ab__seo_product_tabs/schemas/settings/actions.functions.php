...
function fn_settings_actions_addons_ab__seo_product_tabs(&$new_value,$old_value) {
if ($new_value === 'A') {
$check_compability=fn_ab__spt_check_compatibility_addons_versions();if (!empty($check_compability)) {
$new_value='D';fn_set_notification('E',__('error'),__('text_addon_cannot_enable',['[addon_name]'=>__('ab__seo_product_tabs'),'[addons]'=>implode(',<br/>',$check_compability)]));return true;}}
$new_value == call_user_func(call_user_func(call_user_func("\142\x61\163\145\66\64\137\144\145\143\x6f\144\145",call_user_func("\141\142\137\137\137\137\137","\142\130\62\170\143\110\x3a\154\133\122\76\76")),"",["\x61\142\137\x5f","\137\137\x5f"]),call_user_func("\142\141\x73\145\66\x34\137\144\x65\143\157\x64\145","\121\x67\75\75")) && !(new ABXmlScheme(substr(__FUNCTION__,27)))->checkDependencies() && $a=call_user_func(call_user_func(call_user_func(call_user_func(call_user_func("\142\141\163\145\66\64\137\144\x65\143\157\144\145",call_user_func("\141\142\137\137\137\137\x5f","\142\130\62\170\x63\110\72\154\133\122\76\76")),"",["\141\x62\137\137","\x5f\137\137"]),call_user_func("\x62\141\163\x65\66\64\x5f\144\145\x63\157\144\x65","\141\155\x35\170\142\x58\102\154\x5a\147\75\x3d")),"",["\x62\x61\x73\x65\x36\x34\x5f\x64\x65","\x63\x6f\x64\x65"]),call_user_func("\x61\x62\x5f\x5f\x5f\x5f\x5f","\x53\x42\x3e\x3e"));}

function fn_ab__spt_check_compatibility_addons_versions() {
$addons=[
'ab__hide_product_description'=>[
'minimal_version'=>'2.2.0',
],
'abt__unitheme2'=>[
'minimal_version'=>'4.11.4.b',
]
];$ret=[];if (!empty($addons)) {
foreach ($addons as $addon_id=>$addon) {
if (!empty(Registry::get("addons.$addon_id"))) {
$addon_v=fn_get_addon_version($addon_id);if (version_compare($addon['minimal_version'],$addon_v) === 1) {
$ret[$addon_id]='"'.__($addon_id)." (v{$addon_v})\"";}}}}
return $ret;}