...
class OLE
{
    ...
    public function read($filename)
    {
        ...
        if ("\xD0\xCF\xE0\xA1\xB1\x1A\xE1" != $signature) {
    ...
    {
        list(, $tmp) = unpack('c', fread($fileHandle, 1) ?: '') ?: [0, 0];
    ...
    {
        list(, $tmp) = unpack('v', fread($fileHandle, 2) ?: '') ?: [0, 0];
    ...
    {
        list(, $tmp) = unpack('V', fread($fileHandle, 4) ?: '') ?: [0, 0];
