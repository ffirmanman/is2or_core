...
interface IWriter
{
     ...
     *                                  self::SAVE_WITH_CHARTS                Save any
     *                                  charts that are defined (if the Writer supports
     *                                  Charts) self::DISABLE_PRECALCULATE_FORMULAE
     *                                  Don't Precalculate formulae before saving the file
     *
     * @throws Exception
     */
