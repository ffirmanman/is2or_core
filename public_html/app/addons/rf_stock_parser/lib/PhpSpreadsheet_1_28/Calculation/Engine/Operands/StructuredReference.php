...
final class StructuredReference implements Operand
{
    ...
    public function parse(Cell $cell): string
    {
        ...
        return ($this->isRowReference()) ? $this->getRowReference($cell) : $this->getColumnReference();
    }
    ...
    private function getColumnReference(): string
    {
        ...
        list($startRow, $endRow) = $this->getRowsForColumnReference($reference, $startRow, $endRow);
