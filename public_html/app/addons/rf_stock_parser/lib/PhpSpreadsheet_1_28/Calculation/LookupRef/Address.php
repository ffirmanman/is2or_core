...
class Address
{
     ...
     *                              1 or omitted    Absolute 2               Absolute row;
     *                              relative column 3               Relative row; absolute
     *                              column 4               Relative Or can be an array of
     *                              values
    ...
    private static function formatAsR1C1(int $row, int $column, int $relativity, string $sheetName): string
    {
        ...
        list($rowChar, $colChar) = AddressHelper::getRowAndColumnChars();
