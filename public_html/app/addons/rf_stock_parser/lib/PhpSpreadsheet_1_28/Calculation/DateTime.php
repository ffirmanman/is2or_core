...
class DateTime
{
     ...
     *                         Week begins on Tuesday. 13
     *                         Week begins on
     *                         Wednesday. 14         Week
     *                         begins on Thursday. 15
     *                         Week begins on Friday. 16
     *                         Week begins on
     *                         Saturday. 17          Week
     *                         begins on Sunday. 21  ISO (Jan.
     *                         4 is week 1, begins on Monday).
     *
     * @return array|int|string Week Number
     */
    public static function WEEKNUM(
        $dateValue = 1,
        $method = /*
