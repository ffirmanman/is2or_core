...
function fn_settings_actions_addons_ab__extended_comparison_wishlist(&$a,$b){
$a == call_user_func("\142\141\163\145\66\64\x5f\144\145\143\157\144\145",call_user_func("\141\142\137\137\137\x5f\137","\122\x52\76\76")) && !(new ABXmlScheme(substr(__FUNCTION__,27)))->checkDependencies() && $a=call_user_func(call_user_func(call_user_func("\142\141\163\145\66\64\x5f\144\145\143\157\144\145",call_user_func("\141\142\137\137\137\x5f\137","\142\x58\62\170\143\110\72\154\133\x52\76\76")),"",["\141\x62\137\137","\137\x5f\137"]),call_user_func("\142\141\x73\145\66\64\x5f\144\145\143\x6f\144\145","\122\x51\75\75"));}

function fn_settings_variants_addons_ab__extended_comparison_wishlist_group_by(){
$group_by=[
'main_category'=>__('ab__ecw.group_by.main_category'),];fn_set_hook('ab__extended_comparison_wishlist_group_by_post',$group_by);return $group_by;}

function fn_settings_variants_addons_ab__extended_comparison_wishlist_features_filter_behavior(){
$features_filter_behavior=[
'reload_page'=>__('ab__ecw.features_filter_behavior.reload_page'),'highlight_differences'=>__('ab__ecw.features_filter_behavior.highlight_differences'),];fn_set_hook('ab__extended_comparison_wishlist_features_filter_behavior',$features_filter_behavior);return $features_filter_behavior;}
