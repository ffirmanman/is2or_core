                                            ...
                                            {if $subitem.subitems}
                                                <div class="ut2-tlw">
                                                    {if $subitem.subitems|count > $props.abt__no_hidden_elements_third_level_view}
                                                        <a href="{if $block.properties.abt__ut2_view_more_btn_behavior|default:'view_items' === 'view_items'}#" onclick="$(this).parent().find('a').removeClass('hidden');$(this).addClass('hidden');{else}{$subitem.href|fn_url|default:"javascript:void(0)"}" rel="nofollow{/if}" class="ut2-lsl__more-link" title=""><span>{__("more")}</span></a>
                                                    {/if}
