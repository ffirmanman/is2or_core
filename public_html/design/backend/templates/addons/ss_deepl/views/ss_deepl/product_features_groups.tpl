    ...
    <div class="control-group">
        ...
        <div class="controls">
            <label class="checkbox">
                ...
                {if $addons.ss_deepl.ss_deepl_sections_product_features_groups.internal_name == "Y"}checked="checked"{/if}/> {__("name")}
            </label>
            <label class="checkbox">
                ...
                {if $addons.ss_deepl.ss_deepl_sections_product_features_groups.description == "Y"}checked="checked"{/if}/> {__("storefront_name")}
            </label>
            <label class="checkbox">
                ...
                {if $addons.ss_deepl.ss_deepl_sections_product_features_groups.full_description == "Y"}checked="checked"{/if}/> {__("description")}
            </label>
        </div>
    </div>
...
{capture name="buttons"}
    {include file="buttons/button.tpl" but_text=__("ss_deepl_button_product_features_groups") but_name="dispatch[ss_deepl.mass_translate_product_features_groups]" but_role="submit-link" but_target_form="ss_deepl_form"}
    {dropdown content=$smarty.capture.tools_list}
{/capture}

{/capture}

{include file="common/mainbox.tpl" title={__("ss_deepl_product_features_groups_translate")} content=$smarty.capture.mainbox buttons=$smarty.capture.buttons}