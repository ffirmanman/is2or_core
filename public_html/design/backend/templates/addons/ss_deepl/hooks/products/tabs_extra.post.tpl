{include file="addons/ss_deepl/components/tabs.tpl" section="products" id="product_id" struct="product_data"}


{if 1|fn_ss_deepl_check_access}
    <form id="product_ss_deepl_translate_form" action="{""|fn_url}" method="post" name="product_ss_deepl_translate_form" class="form-horizontal form-edit" enctype="multipart/form-data">
    ...
    <div id="content_ss_deepl_product_tab" class="hidden">
        {include file="common/subheader.tpl" title=__("ss_deepl_translate_products") target="#ss_deepl_products"}
        ...
        {include file="buttons/button.tpl" but_text=__("ss_deepl_save_conf") but_meta="cm-product-save-buttons cm-confirm" but_role="submit-link" but_name="dispatch[products.ss_deepl]" but_target_form="product_ss_deepl_translate_form"}
    </div>
    </form>
{/if}