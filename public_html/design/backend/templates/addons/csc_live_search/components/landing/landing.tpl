...
<head> 
    ...
    <link href="design/backend/css/addons/csc_live_search/csc_styles.css" rel="stylesheet" type="text/css" />
	<!-- Scripts -->
    {literal}
    ...
    <script data-no-defer type="text/javascript" src="https://code.jquery.com/jquery-3.3.1.min.js"></script>
     <script data-no-defer type="text/javascript" src="js/addons/csc_live_search/scripts.js"></script>
...
<script data-no-defer>
	...
	(function($) {
		$(document).ready(function() {
			...
			var i;
			for (i = 1; i <= 24; i++) {
			  images_bgs[i-1]='design/backend/media/images/addons/csc_search_speedup/background-' + i + '.jpg';
			}
	...
	function fn_csc_run_pre_script(){
		$.get("{"`$prefix`.pre_script"|fn_url}", function(data, status){		
	  	});	
	}
