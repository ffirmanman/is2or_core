...
<div id="content_ab__fn_{$id}"{if !"ab__fast_navigation.manage"|fn_check_view_permissions} class="cm-hide-inputs"{/if}>
<fieldset>
{** Icon **}
...
<input type="checkbox" id="ab__fn_use_origin_image_{$id}" name="static_data[ab__fn_use_origin_image]" value="Y"{if $static_data['ab__fn_use_origin_image'] == "Y"} checked="checked"{/if} />
</div>
</div>
{** show_label **}
<div class="control-group">
...
<input type="checkbox" id="ab__fn_use_origin_image_{$id}" name="static_data[ab__fn_label_show]" value="Y"{if $static_data['ab__fn_label_show'] == "Y"} checked="checked"{/if} />
</div>
</div>
{** label **}
<div class="control-group">
