            ...
            {foreach from=$messages item=post}
                ...
                <div class="vendor-communication-post__content vendor-communication-post-item
                    ...
                    <div class="vendor-communication-post__img">
                        {if $post.user_type == "V"}
                            <div class="vendor-communication-post__img-content">
                        ...
                        {if $post.user_type === "A"}
                            <div class="vendor-communication-post__img-content">
                                {include_ext file="common/icon.tpl"
                                    source="user"
                                    class="vendor-communication-post__img-icon"
                                }
                            </div>
                        {/if}
                    </div>
                        ...
                        <div class="buttons-container">
                            {if $thread.thread_id}
                                {include
                                    ...
                                    but_meta="cm-ajax btn btn-link btn-icon-link animation-rotate add_message_form--refresh-btn link--monochrome"
                                    but_rel="nofollow"
                                }
                                {if $allow_send}
                                    {include
