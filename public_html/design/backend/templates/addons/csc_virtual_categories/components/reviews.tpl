        ...
        <ul>
            <li class="stars"><a href="{$url}" target="_blank"><i></i><i></i><i></i><i></i><i></i></a>
             ...
             <li class="rate-us"><a href="https://www.cs-commerce.com/" target="_blank">{__("`$prefix`.other_addons")}</a></li>
              {if $subscription.documentation=="Y"}
             <li class="rate-us"><p></p><p><a class="btn"  href="https://docs.cs-commerce.com/docs/{$addon}" target="_blank">{__("`$prefix`.documentation")}</a></p></li>
           {/if}
