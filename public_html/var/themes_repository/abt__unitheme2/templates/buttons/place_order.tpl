...
>
    <span class="litecheckout__submit-btn__in">
        ...
        <span class="ut2-icon-outline-verified_user"></span><span class="litecheckout__submit-btn__caption">{$but_text nofilter}</span>&#32;<span class="litecheckout__submit-btn__order-total">({$smarty.capture.order_total nofilter})</span>
    </span>
