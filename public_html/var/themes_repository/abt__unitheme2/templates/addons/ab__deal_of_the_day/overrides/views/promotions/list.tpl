        ...
        <div class="ab__dotd_promotions-item {if !$promotion.ab__dotd_active}ab__dotd_promotion_expired{/if}">
            <div class="ab__dotd_promotions-item_image">
                <a href="{"promotions.view?promotion_id=`$promotion.promotion_id`"|fn_url}">
                    {include file="common/image.tpl" images=$promotion.image no_ids=true}
                </a>
            </div>
    ...
    <div class="ab__dotd_chains">
        ...
        <div class="ab__dotd_chains_content">
            ...
            {if $chains_search.total_pages > 1}
                <div class="ut2-load-more-container-btg">
                    <div class="ut2-load-more-btg ab__dotd_chains-show_more">
                        <span class="loader-wrapper"><i class="loader"></i></span>
                        <span class="ab__dotd-text_get_more loader-text">{__('ab__dotd.get_more_combinations', [$chains_search.more])}</span>
                    </div>
                </div>
            {/if}
        </div>
