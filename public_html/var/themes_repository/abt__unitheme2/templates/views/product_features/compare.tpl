            ...
            <table class="ty-compare-products">
                <tr>
                    ...
                    <td class="ty-compare-products__product">
                        ...
                        <a href="{"product_features.delete_product?product_id=`$compare_product_id`&redirect_url=`$return_current_url`"|fn_url}" class="ty-remove"  title="{__("remove")}">{include_ext file="common/icon.tpl" class="ut2-icon-delete"} {__("remove")}</a>
                    </td>
                    {/foreach}
                </tr>
            </table>
