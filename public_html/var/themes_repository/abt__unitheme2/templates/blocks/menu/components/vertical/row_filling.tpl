                                ...
                                <div class="ut2-menu__2nd-submenu__wrapper">
                                    ...
                                    {else}
                                        ...
                                        {if $item2.$childs|count > $Viewlimit}
                                            {if $block.properties.abt__ut2_view_more_btn_behavior|default:"view_items" === "view_items"}
                                                <a class="ut2-more-btn view-items" href="javascript:void(0);" onclick="$(this).prev().addClass('view');$(this).addClass('hidden');" rel="nofollow">
                                                    <span>{__("more")}</span><i class="ut2-icon-outline-expand_more"></i>
                                                </a>
                                            {else}
                                                <a class="ut2-more-btn load-url" href="{$item2_url|default:"javascript:void(0)"}" rel="nofollow">
                                                    <span>{__("more")}</span><i class="ut2-icon-outline-arrow_forward"></i>
                                                </a>
                                            {/if}
                                        {/if}
                                    {/if}
