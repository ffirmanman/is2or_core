{if $products}
    ...
    <div class="ty-compact-list {if $settings.abt__ut2.product_list.short_list.show_two_columns[$settings.ab__device] === "YesNo::YES"|enum} show-two-columns{/if}" style="--compact-list-image-width: {$tbw};--compact-list-image-height: {$tbh};">
