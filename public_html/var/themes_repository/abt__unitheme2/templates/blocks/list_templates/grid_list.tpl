...
{if $products_scroller}
    ...
    <div class="grid-list {if $block.properties.item_quantity}ut2-gl__simple-scroller{/if} ut2-scroll-container {$show_custom_class}" id="{$id}" style="--gl-lines-in-name-product: {$settings.abt__ut2.product_list.$tmpl.lines_number_in_name_product[$settings.ab__device]};
