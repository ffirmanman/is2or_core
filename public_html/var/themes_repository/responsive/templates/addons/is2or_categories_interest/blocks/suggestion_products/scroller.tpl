    ...
    {foreach from=$items item="product" name="for_products"}
        <div class="ty-scroller-list__item ty-scroller__item">
            ...
            <div class="ty-scroller-list__description">
                {strip}
                    {include file="blocks/list_templates/simple_list.tpl" product=$product show_name=true show_price=true show_add_to_cart=false but_role="action" hide_price=$_hide_price hide_qty=true show_product_labels=true show_discount_label=true show_shipping_label=true}
                {/strip}
            </div>
        </div>
    {/foreach}
