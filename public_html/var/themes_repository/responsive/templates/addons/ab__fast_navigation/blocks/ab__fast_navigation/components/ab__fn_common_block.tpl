...
{if $items}
    ...
    {assign var="cols_desktop" value=(($block.properties.ab__fn_number_of_columns_desktop|intval > 0) ? $block.properties.ab__fn_number_of_columns_desktop : 10)}

    {assign var="cols_desktop_small" value=(($block.properties.ab__fn_number_of_columns_desktop_small|intval > 0) ? $block.properties.ab__fn_number_of_columns_desktop_small : 6)}

    {assign var="cols_tablet" value=(($block.properties.ab__fn_number_of_columns_tablet|intval > 0) ? $block.properties.ab__fn_number_of_columns_tablet : 5)}

    {assign var="cols_tablet_small" value=(($block.properties.ab__fn_number_of_columns_tablet_small|intval > 0) ? $block.properties.ab__fn_number_of_columns_tablet_small : 4)}

    {assign var="cols_mobile" value=(($block.properties.ab__fn_number_of_columns_mobile|intval > 0) ? $block.properties.ab__fn_number_of_columns_mobile : 3)}
